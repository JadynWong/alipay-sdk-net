...
namespace Aop.Api.Domain
{
    ...
    public class ActivityPlanInfo : AopObject
    {
        ...
        /// 招商结束时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("confirm_end_time")]
        public string ConfirmEndTime { get; set; }

        /// <summary>
        /// 平台活动邀约工单号(需要在第三方活动中回传)
        /// </summary>
        [Newtonsoft.Json.JsonProperty("invite_order_id")]
        ...
        /// 是个链接地址，下载后是pdf文件
        /// </summary>
        [Newtonsoft.Json.JsonProperty("plat_activity_agreement")]
        public string PlatActivityAgreement { get; set; }

        /// <summary>
        /// 平台活动id（需要在第三方方活动中回传）
        /// </summary>
        [Newtonsoft.Json.JsonProperty("plat_activity_id")]
        public string PlatActivityId { get; set; }

        /// <summary>
        /// 平台活动标签类型
        /// </summary>
        [Newtonsoft.Json.JsonProperty("plat_activity_label_type")]
        public string PlatActivityLabelType { get; set; }

        /// <summary>
        /// 平台活动名称
        /// </summary>
        [Newtonsoft.Json.JsonProperty("plat_activity_name")]
        public string PlatActivityName { get; set; }

        /// <summary>
        /// 活动规则描述
        /// </summary>
        [Newtonsoft.Json.JsonProperty("plat_activity_rule_desc")]
        public string PlatActivityRuleDesc { get; set; }

        /// <summary>
        /// 平台活动状态,GOING/FINISH,GOING表示招商中,FINISH表示招商已经结束(再报名活动也无法成功),只有GOING状态可以报名
        /// </summary>
        [Newtonsoft.Json.JsonProperty("plat_activity_status")]
        public string PlatActivityStatus { get; set; }

        /// <summary>
        /// 其他说明
        /// </summary>
        [Newtonsoft.Json.JsonProperty("plat_other_desc")]

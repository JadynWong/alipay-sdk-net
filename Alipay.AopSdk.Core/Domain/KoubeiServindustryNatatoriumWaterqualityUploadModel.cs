...
namespace Aop.Api.Domain
{
    ...
    public class KoubeiServindustryNatatoriumWaterqualityUploadModel : AopObject
    {
        ...
        /// 游泳馆当前时间人数
        /// </summary>
        [Newtonsoft.Json.JsonProperty("current_num")]
        public long CurrentNum { get; set; }

        /// <summary>
        /// 当前场馆内人数更新时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("currentnum_update_time")]

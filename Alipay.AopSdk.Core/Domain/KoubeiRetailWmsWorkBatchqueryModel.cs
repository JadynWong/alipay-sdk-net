...
namespace Aop.Api.Domain
{
    ...
    public class KoubeiRetailWmsWorkBatchqueryModel : AopObject
    {
        ...
        /// 完成时间范围开始时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("gmt_finished_from")]
        public string GmtFinishedFrom { get; set; }

        /// <summary>
        /// 完成时间范围结束时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("gmt_finished_to")]
        public string GmtFinishedTo { get; set; }

        /// <summary>
        /// 作业对应的入库/出库通知单的外部业务单据号，这个单据可能是采购单、补货单等
        /// </summary>
        [Newtonsoft.Json.JsonProperty("notice_out_biz_no")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("notice_out_biz_type")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("work_type")]

...
namespace Aop.Api.Domain
{
    ...
    public class AlipayTradePagePayModel : AopObject
    {
        ...
        /// 签约参数，支付后签约场景使用
        /// </summary>
        [Newtonsoft.Json.JsonProperty("agreement_sign_params")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("integration_type")]

...
namespace Aop.Api.Domain
{
    ...
    public class CertAuditResult : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("authority_check_retcode")]
        public string AuthorityCheckRetcode { get; set; }

        /// <summary>
        /// 官方渠道信息比对结果返回信息
        /// </summary>
        [Newtonsoft.Json.JsonProperty("authority_check_retmessage")]
        public string AuthorityCheckRetmessage { get; set; }

        /// <summary>
        /// 官方渠道信息比对结果，通过Y，不通过N，待定U
        /// </summary>
        [Newtonsoft.Json.JsonProperty("authority_check_suggest")]
        public string AuthorityCheckSuggest { get; set; }

        /// <summary>
        /// 证件上人脸比对结果，通过Y，不通过N，待定U
        /// </summary>
        [Newtonsoft.Json.JsonProperty("cert_face_suggest")]
        public string CertFaceSuggest { get; set; }

        /// <summary>
        /// 合规结果，通过Y，不通过N，待定U
        /// </summary>
        [Newtonsoft.Json.JsonProperty("compliance_suggest")]
        public string ComplianceSuggest { get; set; }

        /// <summary>
        /// ocr结果
        /// </summary>
        [Newtonsoft.Json.JsonProperty("ocr")]
        public CertFields Ocr { get; set; }

        /// <summary>
        /// ocr比对结果，通过Y，不通过N，待定U
        /// </summary>
        [Newtonsoft.Json.JsonProperty("ocr_check_suggest")]

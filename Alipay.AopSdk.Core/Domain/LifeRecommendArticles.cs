...
namespace Aop.Api.Domain
{
    ...
    public class LifeRecommendArticles : AopObject
    {
        ...
        /// 文章封面图片
        /// </summary>
        [Newtonsoft.Json.JsonProperty("article_image")]
        public string ArticleImage { get; set; }

        /// <summary>
        /// 支付宝钱包的文章详情地址
        /// </summary>
        [Newtonsoft.Json.JsonProperty("article_link")]
        public string ArticleLink { get; set; }

        /// <summary>
        /// 文章阅读数
        /// </summary>
        [Newtonsoft.Json.JsonProperty("article_read_cnt")]
        public string ArticleReadCnt { get; set; }

        /// <summary>
        /// 文章来源
        /// </summary>
        [Newtonsoft.Json.JsonProperty("article_source")]

...
namespace Aop.Api.Domain
{
    ...
    public class KoubeiItemCreateModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("item_detail_url")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("shop_ids")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("tb_cover")]
        public string TbCover { get; set; }

        /// <summary>
        /// 交易凭证类商品模板信息
        /// </summary>
        [Newtonsoft.Json.JsonProperty("trade_voucher_item_template")]

...
namespace Aop.Api.Domain
{
    ...
    public class IntelligentPromo : AopObject
    {
        ...
        /// 是否允许自动续期
        /// </summary>
        [Newtonsoft.Json.JsonProperty("allow_auto_delay")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("forecast_effect")]
        public IntelligentPromoEffect ForecastEffect { get; set; }

        /// <summary>
        /// 智能营销活动下架的时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("gmt_closed")]
        public string GmtClosed { get; set; }

        /// <summary>
        /// 智能营销活动的生效时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("gmt_enabled")]

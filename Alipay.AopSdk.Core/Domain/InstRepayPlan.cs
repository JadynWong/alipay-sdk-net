...
namespace Aop.Api.Domain
{
    ...
    public class InstRepayPlan : AopObject
    {
        ...
        /// 当期利息，单位：元
        /// </summary>
        [Newtonsoft.Json.JsonProperty("cur_term_interest")]
        public string CurTermInterest { get; set; }

        /// <summary>
        /// 当期利息罚息，单位：元
        /// </summary>
        [Newtonsoft.Json.JsonProperty("cur_term_interest_penalty")]
        public string CurTermInterestPenalty { get; set; }

        /// <summary>
        /// 当期本金，单位：元
        /// </summary>
        [Newtonsoft.Json.JsonProperty("cur_term_principal")]
        public string CurTermPrincipal { get; set; }

        /// <summary>
        /// 当期本金罚息，单位：元
        /// </summary>
        [Newtonsoft.Json.JsonProperty("cur_term_principal_penalty")]
        public string CurTermPrincipalPenalty { get; set; }

        /// <summary>
        /// 当期已还利息，单位：元
        /// </summary>
        [Newtonsoft.Json.JsonProperty("repaid_interest")]
        public string RepaidInterest { get; set; }

        /// <summary>
        /// 当期已还利息罚息，单位：元
        /// </summary>
        [Newtonsoft.Json.JsonProperty("repaid_interest_penalty")]
        public string RepaidInterestPenalty { get; set; }

        /// <summary>
        /// 当期已还本金，单位：元
        /// </summary>
        [Newtonsoft.Json.JsonProperty("repaid_principal")]
        public string RepaidPrincipal { get; set; }

        /// <summary>
        /// 当期已还本金罚息，单位：元
        /// </summary>
        [Newtonsoft.Json.JsonProperty("repaid_principal_penalty")]

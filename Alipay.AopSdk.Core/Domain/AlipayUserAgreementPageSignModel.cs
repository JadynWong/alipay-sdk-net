...
namespace Aop.Api.Domain
{
    ...
    public class AlipayUserAgreementPageSignModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("access_params")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("agreement_effect_type")]
        public string AgreementEffectType { get; set; }

        /// <summary>
        /// 设备信息参数，在使用设备维度签约代扣协议时，可以传这些信息
        /// </summary>
        [Newtonsoft.Json.JsonProperty("device_params")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("external_agreement_no")]
        public string ExternalAgreementNo { get; set; }

        /// <summary>
        /// 用户在商户网站的登录账号，用于在签约页面展示，如果为空，则不展示
        /// </summary>
        [Newtonsoft.Json.JsonProperty("external_logon_id")]
        public string ExternalLogonId { get; set; }

        /// <summary>
        /// 用户实名信息参数，包含：姓名、身份证号、签约指定uid。商户传入用户实名信息参数，支付宝会对比用户在支付宝端的实名信息。
        /// </summary>
        [Newtonsoft.Json.JsonProperty("identity_params")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("merchant_process_url")]
        public string MerchantProcessUrl { get; set; }

        /// <summary>
        /// 个人签约产品码，商户和支付宝签约时确定，商户可咨询技术支持。
        /// </summary>
        [Newtonsoft.Json.JsonProperty("personal_product_code")]
        public string PersonalProductCode { get; set; }

        /// <summary>
        /// 签约产品属性，json格式
        /// </summary>
        [Newtonsoft.Json.JsonProperty("prod_params")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("third_party_type")]
        public string ThirdPartyType { get; set; }

        /// <summary>
        /// 芝麻授权信息，针对于信用代扣签约。json格式。
        /// </summary>
        [Newtonsoft.Json.JsonProperty("zm_auth_params")]

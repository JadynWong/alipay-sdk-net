...
namespace Aop.Api.Domain
{
    ...
    public class AlipayEcoEduJzPostPublishModel : AopObject
    {
        ...
        /// 年龄要求范围
        /// </summary>
        [Newtonsoft.Json.JsonProperty("age_demand")]
        ...
        /// 客服联系方式
        /// </summary>
        [Newtonsoft.Json.JsonProperty("company_contact")]
        ...
        /// 招聘人数
        /// </summary>
        [Newtonsoft.Json.JsonProperty("hire_number")]
        public string HireNumber { get; set; }

        /// <summary>
        /// 有无提成0:没有1:有
        /// </summary>
        [Newtonsoft.Json.JsonProperty("is_commission")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("part_time_type")]
        ...
        /// 薪资待遇备注
        /// </summary>
        [Newtonsoft.Json.JsonProperty("payment_remark")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("salary_unit")]
        public string SalaryUnit { get; set; }

        /// <summary>
        /// 兼职服务商职位id
        /// </summary>
        [Newtonsoft.Json.JsonProperty("service_post_id")]
        ...
        /// 工作时间备注
        /// </summary>
        [Newtonsoft.Json.JsonProperty("work_time_remark")]
        public string WorkTimeRemark { get; set; }

        /// <summary>
        /// 每天工作时长 <以小时计>
        /// </summary>
        [Newtonsoft.Json.JsonProperty("working_hours")]

...
namespace Aop.Api.Domain
{
    ...
    public class AlipayInsSceneCouponSendModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("channel_user_id")]
        public string ChannelUserId { get; set; }

        /// <summary>
        /// 渠道账号来源;1:支付宝账号 2:淘宝账号;如果证件类型字段没填则必填
        /// </summary>
        [Newtonsoft.Json.JsonProperty("channel_user_source")]
        public string ChannelUserSource { get; set; }

        /// <summary>
        /// 活动维度id;  商户PID值
        /// </summary>
        [Newtonsoft.Json.JsonProperty("dimension_id")]
        public string DimensionId { get; set; }

        /// <summary>
        /// 活动维度;  GOODS:淘宝商品,ANT_PID:蚂蚁商户PID
        /// </summary>
        [Newtonsoft.Json.JsonProperty("dimension_type")]
        public string DimensionType { get; set; }

        /// <summary>
        /// 市场类型;  TAOBAO:淘宝平台,ANT: 蚂蚁平台
        /// </summary>
        [Newtonsoft.Json.JsonProperty("market_type")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("service_scenario")]

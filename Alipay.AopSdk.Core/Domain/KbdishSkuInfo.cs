...
namespace Aop.Api.Domain
{
    ...
    public class KbdishSkuInfo : AopObject
    {
        ...
        /// 餐盒费用
        /// </summary>
        [Newtonsoft.Json.JsonProperty("box_price")]
        ...
        /// 商品的skuId
        /// </summary>
        [Newtonsoft.Json.JsonProperty("goods_sku_id")]
        ...
        /// sku的扩展字典,json字符串
        /// </summary>
        [Newtonsoft.Json.JsonProperty("sku_ext_content")]
        ...
        /// sku的排序字段
        /// </summary>
        [Newtonsoft.Json.JsonProperty("sku_sort")]
        public string SkuSort { get; set; }

        /// <summary>
        /// 规则id1
        /// </summary>
        [Newtonsoft.Json.JsonProperty("spec_code_01")]
        public string SpecCode01 { get; set; }

        /// <summary>
        /// 规格2
        /// </summary>
        [Newtonsoft.Json.JsonProperty("spec_code_02")]
        public string SpecCode02 { get; set; }

        /// <summary>
        /// 规格3
        /// </summary>
        [Newtonsoft.Json.JsonProperty("spec_code_03")]
        public string SpecCode03 { get; set; }

        /// <summary>
        /// 规格4
        /// </summary>
        [Newtonsoft.Json.JsonProperty("spec_code_04")]
        public string SpecCode04 { get; set; }

        /// <summary>
        /// 规格5
        /// </summary>
        [Newtonsoft.Json.JsonProperty("spec_code_05")]

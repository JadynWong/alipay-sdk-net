...
namespace Aop.Api.Domain
{
    ...
    public class DrawndnVo : AopObject
    {
        ...
        /// 实收利息，单位为元，小数点保留2位
        /// </summary>
        [Newtonsoft.Json.JsonProperty("actual_collected_interest")]
        ...
        /// 已收本息，单位为元，小数点保留2位
        /// </summary>
        [Newtonsoft.Json.JsonProperty("collected_principal_and_interest")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("drawndn_date")]
        public string DrawndnDate { get; set; }

        /// <summary>
        /// 支用编号，代表一笔支用的唯一编号
        /// </summary>
        [Newtonsoft.Json.JsonProperty("drawndn_no")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("five_tier_classification")]
        ...
        /// 贷款发放额，单位为元，小数点保留2位
        /// </summary>
        [Newtonsoft.Json.JsonProperty("lending_amount")]
        public string LendingAmount { get; set; }

        /// <summary>
        /// 当前逾期期次
        /// </summary>
        [Newtonsoft.Json.JsonProperty("overduce_terms")]

...
namespace Aop.Api.Domain
{
    ...
    public class VoucherRec : AopObject
    {
        ...
        /// 总收藏量
        /// </summary>
        [Newtonsoft.Json.JsonProperty("all_keep_count")]
        ...
        /// 是否有面向人群
        /// </summary>
        [Newtonsoft.Json.JsonProperty("has_crowd")]
        public string HasCrowd { get; set; }

        /// <summary>
        /// 是否自动领取券
        /// </summary>
        [Newtonsoft.Json.JsonProperty("is_auto_obtain")]
        public string IsAutoObtain { get; set; }

        /// <summary>
        /// 是否是商圈发的券
        /// </summary>
        [Newtonsoft.Json.JsonProperty("is_mall_voucher")]
        public string IsMallVoucher { get; set; }

        /// <summary>
        /// 券品牌名称
        /// </summary>
        [Newtonsoft.Json.JsonProperty("item_brand_name")]
        public string ItemBrandName { get; set; }

        /// <summary>
        /// 券有效期结束时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("item_gmt_end")]
        public string ItemGmtEnd { get; set; }

        /// <summary>
        /// 券有效期开始时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("item_gmt_start")]
        ...
        /// 销售模式
        /// </summary>
        [Newtonsoft.Json.JsonProperty("item_sales_mode")]
        public string ItemSalesMode { get; set; }

        /// <summary>
        /// 销量
        /// </summary>
        [Newtonsoft.Json.JsonProperty("item_sold_quantity")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("per_value_amount")]
        public string PerValueAmount { get; set; }

        /// <summary>
        /// 泛行业商品详情图片
        /// </summary>
        [Newtonsoft.Json.JsonProperty("picture_details")]
        public string PictureDetails { get; set; }

        /// <summary>
        /// 价格浮动模式
        /// </summary>
        [Newtonsoft.Json.JsonProperty("price_mode")]
        ...
        /// 使用门槛
        /// </summary>
        [Newtonsoft.Json.JsonProperty("use_condition_amount")]
        public string UseConditionAmount { get; set; }

        /// <summary>
        /// 券使用的有效时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("valid_times")]
        ...
        /// 券的跳转地址
        /// </summary>
        [Newtonsoft.Json.JsonProperty("voucher_detail_url")]
        public string VoucherDetailUrl { get; set; }

        /// <summary>
        /// 券地址
        /// </summary>
        [Newtonsoft.Json.JsonProperty("voucher_logo_url")]

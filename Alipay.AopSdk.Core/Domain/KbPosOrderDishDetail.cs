...
namespace Aop.Api.Domain
{
    ...
    public class KbPosOrderDishDetail : AopObject
    {
        ...
        /// 是否可以享受优惠
        /// </summary>
        [Newtonsoft.Json.JsonProperty("discountable")]
        ...
        /// 菜品数量，≥1
        /// </summary>
        [Newtonsoft.Json.JsonProperty("dish_num")]
        public long DishNum { get; set; }

        /// <summary>
        /// 菜品单位
        /// </summary>
        [Newtonsoft.Json.JsonProperty("dish_unit")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("practice_info")]
        public string PracticeInfo { get; set; }

        /// <summary>
        /// 做法合计加价（单价），以元为单位，精度到分
        /// </summary>
        [Newtonsoft.Json.JsonProperty("practice_price")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("user_identity")]
        public string UserIdentity { get; set; }

        /// <summary>
        /// 叫起状态，取值约定：WAIT-等待叫起，UP-已叫起
        /// </summary>
        [Newtonsoft.Json.JsonProperty("wake_status")]

...
namespace Aop.Api.Domain
{
    ...
    public class MenuAnalysisData : AopObject
    {
        ...
        /// 人均点击次数
        /// </summary>
        [Newtonsoft.Json.JsonProperty("avg_click_user_cnt")]
        public string AvgClickUserCnt { get; set; }

        /// <summary>
        /// 菜单点击次数
        /// </summary>
        [Newtonsoft.Json.JsonProperty("click_cnt")]
        public long ClickCnt { get; set; }

        /// <summary>
        /// 菜单点击人数
        /// </summary>
        [Newtonsoft.Json.JsonProperty("click_user_cnt")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("menu_type")]

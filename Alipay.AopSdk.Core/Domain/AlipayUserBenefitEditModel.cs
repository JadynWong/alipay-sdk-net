...
namespace Aop.Api.Domain
{
    ...
    public class AlipayUserBenefitEditModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("benefit_area_code")]
        public string BenefitAreaCode { get; set; }

        /// <summary>
        /// 权益图标地址
        /// </summary>
        [Newtonsoft.Json.JsonProperty("benefit_icon_url")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("benefit_name_as_area_subtitle")]
        public string BenefitNameAsAreaSubtitle { get; set; }

        /// <summary>
        /// 权益详情页面地址
        /// </summary>
        [Newtonsoft.Json.JsonProperty("benefit_page_url")]
        public string BenefitPageUrl { get; set; }

        /// <summary>
        /// 权益兑换消耗的积分数(修改时必填，防止默认不传的时候被修改成0)
        /// </summary>
        [Newtonsoft.Json.JsonProperty("benefit_point")]
        public long BenefitPoint { get; set; }

        /// <summary>
        /// 权益使用场景索引ID，接入时需要咨询@田豫如何取值
        /// </summary>
        [Newtonsoft.Json.JsonProperty("benefit_rec_biz_id")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("benefit_rec_type")]
        public string BenefitRecType { get; set; }

        /// <summary>
        /// 权益的副标题，用于补充描述权益
        /// </summary>
        [Newtonsoft.Json.JsonProperty("benefit_subtitle")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("eligible_grade")]

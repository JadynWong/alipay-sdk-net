...
namespace Aop.Api.Domain
{
    ...
    public class CPCommServices : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("external_address_scan_result")]
        public string ExternalAddressScanResult { get; set; }

        /// <summary>
        /// 由开发者系统提供的，支付宝根据基础服务类型在特定业务环节调用的外部系统服务地址。
        /// </summary>
        [Newtonsoft.Json.JsonProperty("external_invoke_address")]
        public string ExternalInvokeAddress { get; set; }

        /// <summary>
        /// 服务初始化时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("gmt_created")]

...
namespace Aop.Api.Domain
{
    ...
    public class AlipayMarketingCashvoucherTemplateCreateModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("publish_end_time")]
        public string PublishEndTime { get; set; }

        /// <summary>
        /// 发放开始时间，早于该时间不能发券。发放开始时间不能大于当前时间15天。格式为：yyyy-MM-dd HH:mm:ss
        /// </summary>
        [Newtonsoft.Json.JsonProperty("publish_start_time")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("rule_conf")]
        public string RuleConf { get; set; }

        /// <summary>
        /// 券标语，用于拼接券名称，最多6个字符，券名称=券标语+券面额+’元代金券’,此字段已弃用
        /// </summary>
        [Newtonsoft.Json.JsonProperty("slogan")]
        public string Slogan { get; set; }

        /// <summary>
        /// 券使用说明。JSON数组字符串，最多可以有10条，每条最多50字。如果未传入该字段，将填充为默认描述
        /// </summary>
        [Newtonsoft.Json.JsonProperty("voucher_description")]
        public string VoucherDescription { get; set; }

        /// <summary>
        /// 拟发行券的数量。单位为张。该数值必须是大于0的整数。
        /// </summary>
        [Newtonsoft.Json.JsonProperty("voucher_quantity")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("voucher_use_scene")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("voucher_valid_period")]

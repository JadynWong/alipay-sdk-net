...
namespace Aop.Api.Domain
{
    ...
    public class BaseInfo : AopObject
    {
        ...
        /// 支付宝服务窗名称
        /// </summary>
        [Newtonsoft.Json.JsonProperty("alipay_fuwu_name")]
        ...
        /// 企业logo图片
        /// </summary>
        [Newtonsoft.Json.JsonProperty("logo_pic")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("usage_scenario")]
        ...
        /// 网址授权函图片
        /// </summary>
        [Newtonsoft.Json.JsonProperty("web_auth_pic")]
        public string WebAuthPic { get; set; }

        /// <summary>
        /// 微信公众号名称
        /// </summary>
        [Newtonsoft.Json.JsonProperty("weixin_public_name")]

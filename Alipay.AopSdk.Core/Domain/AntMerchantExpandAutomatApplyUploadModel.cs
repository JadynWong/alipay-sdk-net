...
namespace Aop.Api.Domain
{
    ...
    public class AntMerchantExpandAutomatApplyUploadModel : AopObject
    {
        ...
        /// 自助售卖机合作伙伴信息
        /// </summary>
        [Newtonsoft.Json.JsonProperty("associate")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("machine_cooperation_type")]
        public string MachineCooperationType { get; set; }

        /// <summary>
        /// 机具出厂时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("machine_delivery_date")]
        public string MachineDeliveryDate { get; set; }

        /// <summary>
        /// 机具名称，一般采用厂商名称的简称作为设备名称。8个英文字符或4个中文汉字
        /// </summary>
        [Newtonsoft.Json.JsonProperty("machine_name")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("merchant_user_type")]
        public string MerchantUserType { get; set; }

        /// <summary>
        /// 机具点位地址信息
        /// </summary>
        [Newtonsoft.Json.JsonProperty("point_position")]
        public SmartAddressInfo PointPosition { get; set; }

        /// <summary>
        /// 厂商的支付宝账号ID
        /// </summary>
        [Newtonsoft.Json.JsonProperty("product_user_id")]

...
namespace Aop.Api.Domain
{
    ...
    /// </summary>
    [Serializable]
    public class AlipaySocialBaseChatNewmsgSendModel : AopObject
    {
        /// <summary>
        /// 消息简短描述，显示在会话列表上，必填
        /// </summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("hidden_side")]

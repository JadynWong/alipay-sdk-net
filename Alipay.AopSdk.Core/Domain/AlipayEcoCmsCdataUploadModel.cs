...
namespace Aop.Api.Domain
{
    ...
    public class AlipayEcoCmsCdataUploadModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("merch_id")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("op_data")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("scene_data")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("syn")]
        public bool Syn { get; set; }

        /// <summary>
        /// 消息模板的版本,由开放生态分配
        /// </summary>
        [Newtonsoft.Json.JsonProperty("t_v")]
        public string TV { get; set; }

        /// <summary>
        /// 消息模板ID,需要预先设定模板才能进行消息投放,由开放生态协商分配
        /// </summary>
        [Newtonsoft.Json.JsonProperty("tamplate_id")]

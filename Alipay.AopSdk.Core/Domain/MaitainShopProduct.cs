...
namespace Aop.Api.Domain
{
    ...
    public class MaitainShopProduct : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("off_price")]
        public string OffPrice { get; set; }

        /// <summary>
        /// 原始价格（元），服务商品原始价格，可以和销售价格相同。 新增：必填； 修改：可空
        /// </summary>
        [Newtonsoft.Json.JsonProperty("orig_price")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("out_privilege_id")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("privilege_close_time")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("privilege_price")]
        public string PrivilegePrice { get; set; }

        /// <summary>
        /// 优惠截止时间。格式"yyyy-MM-dd HH:mm:ss"  优惠有效时间，超过时间不再显示优惠价，下单使用销售价格。  新增：可空； 修改：可空  (out_privilege_id、privilege_start_time、privilege_close_time、privilege_tags、privilege_price必须同时存在)
        /// </summary>
        [Newtonsoft.Json.JsonProperty("privilege_start_time")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("service_category_id")]

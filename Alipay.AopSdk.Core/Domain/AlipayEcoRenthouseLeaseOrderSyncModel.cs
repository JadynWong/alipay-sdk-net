...
namespace Aop.Api.Domain
{
    ...
    public class AlipayEcoRenthouseLeaseOrderSyncModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("attach_file")]
        ...
        /// 房源类型  1:分散式  2:集中式
        /// </summary>
        [Newtonsoft.Json.JsonProperty("flats_tag")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("free_deposit")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("furniture_items")]
        ...
        /// 信用减免金额
        /// </summary>
        [Newtonsoft.Json.JsonProperty("rebate_amount")]
        ...
        /// 0-不是续租(默认值)  1-是续租
        /// </summary>
        [Newtonsoft.Json.JsonProperty("renew_lease")]
        public long RenewLease { get; set; }

        /// <summary>
        /// 第几期续租
        /// </summary>
        [Newtonsoft.Json.JsonProperty("renew_num")]
        public long RenewNum { get; set; }

        /// <summary>
        /// 收租日描述
        /// </summary>
        [Newtonsoft.Json.JsonProperty("rent_day_desc")]
        ...
        /// 1-男   2-女
        /// </summary>
        [Newtonsoft.Json.JsonProperty("renter_gender")]
        public string RenterGender { get; set; }

        /// <summary>
        /// 用户姓名
        /// </summary>
        [Newtonsoft.Json.JsonProperty("renter_name")]
        public string RenterName { get; set; }

        /// <summary>
        /// 用户手机号
        /// </summary>
        [Newtonsoft.Json.JsonProperty("renter_phone")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("sale_amount")]

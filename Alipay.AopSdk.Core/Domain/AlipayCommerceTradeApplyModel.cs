...
namespace Aop.Api.Domain
{
    ...
    public class AlipayCommerceTradeApplyModel : AopObject
    {
        ...
        /// 订单费用详情，用于在订单确认页面展示
        /// </summary>
        [Newtonsoft.Json.JsonProperty("amount_detail")]
        ...
        /// 用于标识操作模型，由支付宝配置提供
        /// </summary>
        [Newtonsoft.Json.JsonProperty("op_code")]
        ...
        /// 场景覆盖人群id类型
        /// </summary>
        [Newtonsoft.Json.JsonProperty("target_id_type")]
        public string TargetIdType { get; set; }

        /// <summary>
        /// 交易请求参数
        /// </summary>
        [Newtonsoft.Json.JsonProperty("trade_apply_params")]

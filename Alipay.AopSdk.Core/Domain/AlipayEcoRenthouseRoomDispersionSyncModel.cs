...
namespace Aop.Api.Domain
{
    ...
    public class AlipayEcoRenthouseRoomDispersionSyncModel : AopObject
    {
        ...
        /// 阿里短号
        /// </summary>
        [Newtonsoft.Json.JsonProperty("ali_short_num")]
        public string AliShortNum { get; set; }

        /// <summary>
        /// 户型-房  数值范围：1-26
        /// </summary>
        [Newtonsoft.Json.JsonProperty("bedroom_count")]
        ...
        /// 小区同步请求号
        /// </summary>
        [Newtonsoft.Json.JsonProperty("comm_req_id")]
        ...
        /// 费用说明
        /// </summary>
        [Newtonsoft.Json.JsonProperty("fee_remark")]
        public string FeeRemark { get; set; }

        /// <summary>
        /// 公寓面积 数值范围：5.00㎡-300.00㎡，支持小数点后面2位
        /// </summary>
        [Newtonsoft.Json.JsonProperty("flat_area")]
        public string FlatArea { get; set; }

        /// <summary>
        /// 门牌-栋（楼号）
        /// </summary>
        [Newtonsoft.Json.JsonProperty("flat_building")]
        ...
        /// 门牌-单元
        /// </summary>
        [Newtonsoft.Json.JsonProperty("flat_unit")]
        public string FlatUnit { get; set; }

        /// <summary>
        /// 所在楼层
        /// </summary>
        [Newtonsoft.Json.JsonProperty("floor_count")]
        ...
        /// 免押金开始时间 YYYY-MM-dd
        /// </summary>
        [Newtonsoft.Json.JsonProperty("free_begin_date")]
        public string FreeBeginDate { get; set; }

        /// <summary>
        /// 免押金结束时间 YYYY-MM-dd
        /// </summary>
        [Newtonsoft.Json.JsonProperty("free_end_date")]
        ...
        /// 可签约至YYYY-MM-DD
        /// </summary>
        [Newtonsoft.Json.JsonProperty("max_lease_time")]
        public string MaxLeaseTime { get; set; }

        /// <summary>
        /// 多少天起可租
        /// </summary>
        [Newtonsoft.Json.JsonProperty("min_rent_days")]
        ...
        /// 管家姓名
        /// </summary>
        [Newtonsoft.Json.JsonProperty("owners_name")]
        public string OwnersName { get; set; }

        /// <summary>
        /// 管家手机号码，必须为400开头
        /// </summary>
        [Newtonsoft.Json.JsonProperty("owners_tel")]
        public string OwnersTel { get; set; }

        /// <summary>
        /// 户型-厅   数值范围：0-10
        /// </summary>
        [Newtonsoft.Json.JsonProperty("parlor_count")]
        ...
        /// 出租状态 数值范围：1未租、2已租
        /// </summary>
        [Newtonsoft.Json.JsonProperty("rent_status")]
        public long RentStatus { get; set; }

        /// <summary>
        /// 出租类型 1：整租，2：合租
        /// </summary>
        [Newtonsoft.Json.JsonProperty("rent_type")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("room_area")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("room_face")]
        ...
        /// 房源对应的店铺编号
        /// </summary>
        [Newtonsoft.Json.JsonProperty("room_store_no")]
        public string RoomStoreNo { get; set; }

        /// <summary>
        /// 户型-卫   数值范围：0-10
        /// </summary>
        [Newtonsoft.Json.JsonProperty("toilet_count")]
        public long ToiletCount { get; set; }

        /// <summary>
        /// 房屋总楼层
        /// </summary>
        [Newtonsoft.Json.JsonProperty("total_floor_count")]

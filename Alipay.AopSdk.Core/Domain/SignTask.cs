...
namespace Aop.Api.Domain
{
    ...
    public class SignTask : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("cb_type")]
        public string CbType { get; set; }

        /// <summary>
        /// 回调外部业务系统的地址
        /// </summary>
        [Newtonsoft.Json.JsonProperty("cb_url")]
        public string CbUrl { get; set; }

        /// <summary>
        /// 1 - 云签  2 - 移动签
        /// </summary>
        [Newtonsoft.Json.JsonProperty("cert_sign_type")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("enter_type")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("signer_type")]
        public string SignerType { get; set; }

        /// <summary>
        /// 签约任务有效时长，单位秒。可有外部系统控制时长，如果不传系统会赋予默认值。
        /// </summary>
        [Newtonsoft.Json.JsonProperty("task_expire")]

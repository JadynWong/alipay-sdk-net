...
namespace Aop.Api.Domain
{
    ...
    public class PricingVO : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("expiry_timestamp")]
        public string ExpiryTimestamp { get; set; }

        /// <summary>
        /// 汇率生成时间 用来做幂等 yyyy-MM-dd HH:mm:ss
        /// </summary>
        [Newtonsoft.Json.JsonProperty("generate_timestamp")]
        ...
        /// 中间价
        /// </summary>
        [Newtonsoft.Json.JsonProperty("mid")]
        ...
        /// 源汇率参考id 唯一id
        /// </summary>
        [Newtonsoft.Json.JsonProperty("rate_reference_id")]
        ...
        /// 即期买入价
        /// </summary>
        [Newtonsoft.Json.JsonProperty("spot_bid")]
        public string SpotBid { get; set; }

        /// <summary>
        /// 即期中间价
        /// </summary>
        [Newtonsoft.Json.JsonProperty("spot_mid")]
        public string SpotMid { get; set; }

        /// <summary>
        /// 即期卖出价
        /// </summary>
        [Newtonsoft.Json.JsonProperty("spot_offer")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("threshold_timestamp")]
        public string ThresholdTimestamp { get; set; }

        /// <summary>
        /// 锁汇失效时间 yyyy-MM-dd HH:mm:ss
        /// </summary>
        [Newtonsoft.Json.JsonProperty("valid_timestamp")]

...
namespace Aop.Api.Domain
{
    ...
    public class PromotionInfo : AopObject
    {
        ...
        /// 优惠是否已领取
        /// </summary>
        [Newtonsoft.Json.JsonProperty("collected")]
        public bool Collected { get; set; }

        /// <summary>
        /// 优惠领取总数
        /// </summary>
        [Newtonsoft.Json.JsonProperty("collected_count")]

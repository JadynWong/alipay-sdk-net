...
namespace Aop.Api.Domain
{
    ...
    public class AlipayMarketingCardConsumeSyncModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("act_pay_amount")]
        ...
        /// 门店编号
        /// </summary>
        [Newtonsoft.Json.JsonProperty("shop_code")]
        public string ShopCode { get; set; }

        /// <summary>
        /// 产生该笔交易时，用户出具的凭证类型  ALIPAY：支付宝电子卡  ENTITY：实体卡  OTHER：其他
        /// </summary>
        [Newtonsoft.Json.JsonProperty("swipe_cert_type")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("trade_name")]

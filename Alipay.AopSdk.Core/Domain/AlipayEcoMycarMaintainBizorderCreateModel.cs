...
namespace Aop.Api.Domain
{
    ...
    public class AlipayEcoMycarMaintainBizorderCreateModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("biz_status_txt")]

...
namespace Aop.Api.Domain
{
    ...
    public class YLBProfitDetailInfo : AopObject
    {
        ...
        /// 近1日收益，单位为元
        /// </summary>
        [Newtonsoft.Json.JsonProperty("day_profit")]
        public string DayProfit { get; set; }

        /// <summary>
        /// 近1月收益，单位为元
        /// </summary>
        [Newtonsoft.Json.JsonProperty("month_profit")]
        public string MonthProfit { get; set; }

        /// <summary>
        /// 历史累计收益，单位为元
        /// </summary>
        [Newtonsoft.Json.JsonProperty("total_profit")]
        public string TotalProfit { get; set; }

        /// <summary>
        /// 近1周收益，单位为元
        /// </summary>
        [Newtonsoft.Json.JsonProperty("week_profit")]

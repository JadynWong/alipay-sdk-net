...
namespace Aop.Api.Domain
{
    ...
    public class TemplateStyleInfoDTO : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("banner_img_id")]
        public string BannerImgId { get; set; }

        /// <summary>
        /// banner跳转地址。
        /// </summary>
        [Newtonsoft.Json.JsonProperty("banner_url")]
        ...
        /// 钱包端显示名称（字符串长度）
        /// </summary>
        [Newtonsoft.Json.JsonProperty("card_show_name")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("column_info_layout")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("front_image_enable")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("front_text_list_enable")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("logo_id")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("slogan_img_id")]

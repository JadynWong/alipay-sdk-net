...
namespace Aop.Api.Domain
{
    ...
    public class ZhimaMerchantBorrowEntityUploadModel : AopObject
    {
        ...
        /// 地址描述
        /// </summary>
        [Newtonsoft.Json.JsonProperty("address_desc")]
        public string AddressDesc { get; set; }

        /// <summary>
        /// 是否可借用，Y:可借，N:不可借。如果不可借用，则不在芝麻借还频道地图展示
        /// </summary>
        [Newtonsoft.Json.JsonProperty("can_borrow")]
        public string CanBorrow { get; set; }

        /// <summary>
        /// 可借用数量，如果是借用实物，如自行车，传1即可。如果是借用门店或借还机柜，则传入可借用的物品数量
        /// </summary>
        [Newtonsoft.Json.JsonProperty("can_borrow_cnt")]
        ...
        /// 是否收租金，Y:收租金，N:不收租金
        /// </summary>
        [Newtonsoft.Json.JsonProperty("collect_rent")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("office_hours_desc")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("rent_desc")]
        public string RentDesc { get; set; }

        /// <summary>
        /// 借用总数，如果是借用实物，如自行车，传1即可。如果是借用门店或借还机柜，则传入提供借还物品的总量
        /// </summary>
        [Newtonsoft.Json.JsonProperty("total_borrow_cnt")]

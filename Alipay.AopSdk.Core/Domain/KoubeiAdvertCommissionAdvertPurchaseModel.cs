...
namespace Aop.Api.Domain
{
    ...
    public class KoubeiAdvertCommissionAdvertPurchaseModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("out_unique_id")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("security_code")]

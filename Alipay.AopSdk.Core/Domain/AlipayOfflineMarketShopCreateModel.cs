...
namespace Aop.Api.Domain
{
    ...
    public class AlipayOfflineMarketShopCreateModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("biz_version")]
        ...
        /// （支付宝内部参数）企业支付宝账号。
        /// </summary>
        [Newtonsoft.Json.JsonProperty("enterprise_logon_id")]
        ...
        /// （支付宝内部参数）leads的编号。
        /// </summary>
        [Newtonsoft.Json.JsonProperty("leads_id")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("online_url")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("other_authorization")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("ref_apply_id")]

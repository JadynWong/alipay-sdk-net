...
namespace Aop.Api.Domain
{
    ...
    public class KoubeiMarketingCampaignRetailDmModifyModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("campaign_end_time")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("item_brand")]
        public string ItemBrand { get; set; }

        /// <summary>
        /// 该商品/活动所属类别（吃的:食品   面膜:个人洗护    拖把:家庭清洁）
        /// </summary>
        [Newtonsoft.Json.JsonProperty("item_category")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("member_only")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("thumbnail_image_id")]

...
namespace Aop.Api.Domain
{
    ...
    public class ConditionItemPattern : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("logical_operator")]
        public string LogicalOperator { get; set; }

        /// <summary>
        /// 操作对应的值; 值>0
        /// </summary>
        [Newtonsoft.Json.JsonProperty("operation_value")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("operator_rule")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("rule_unit")]

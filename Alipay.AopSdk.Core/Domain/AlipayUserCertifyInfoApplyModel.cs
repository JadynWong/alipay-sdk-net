...
namespace Aop.Api.Domain
{
    ...
    public class AlipayUserCertifyInfoApplyModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("legal_cert_type")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("org_address")]
        public string OrgAddress { get; set; }

        /// <summary>
        /// 填写营业执照上的经营范围
        /// </summary>
        [Newtonsoft.Json.JsonProperty("org_business_scope")]
        public string OrgBusinessScope { get; set; }

        /// <summary>
        /// 企业所在市，城市的中文完整描述
        /// </summary>
        [Newtonsoft.Json.JsonProperty("org_city")]
        public string OrgCity { get; set; }

        /// <summary>
        /// 企业所在国家，目前只支持 中国
        /// </summary>
        [Newtonsoft.Json.JsonProperty("org_country")]
        public string OrgCountry { get; set; }

        /// <summary>
        /// 营业执照上的经营期限截止日期，日期为10位格式"yyyy-MM-dd“  若为长期，则填“长期”
        /// </summary>
        [Newtonsoft.Json.JsonProperty("org_main_cert_expired_date")]
        public string OrgMainCertExpiredDate { get; set; }

        /// <summary>
        /// 填企业营业执照上的注册号（一般为15位数字）或社会信用代码（18位数字加字母格式大写），如果有信用代码则优先填写社会信用代码
        /// </summary>
        [Newtonsoft.Json.JsonProperty("org_main_cert_no")]
        public string OrgMainCertNo { get; set; }

        /// <summary>
        /// 营业执照图片的base64编码格式的string字符串
        /// </summary>
        [Newtonsoft.Json.JsonProperty("org_main_cert_picture")]
        ...
        /// 企业所在省份，填写省份中文完整信息
        /// </summary>
        [Newtonsoft.Json.JsonProperty("org_province")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("org_type")]
        public string OrgType { get; set; }

        /// <summary>
        /// 注册资本
        /// </summary>
        [Newtonsoft.Json.JsonProperty("register_capital")]

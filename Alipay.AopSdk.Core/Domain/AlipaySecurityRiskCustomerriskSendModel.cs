...
namespace Aop.Api.Domain
{
    ...
    public class AlipaySecurityRiskCustomerriskSendModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("merch_name")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("mobile_ip")]
        public string MobileIp { get; set; }

        /// <summary>
        /// 该账户在商户平台下单时的MAC地址或IP地址（适用于支付宝直连商户回传此信息）
        /// </summary>
        [Newtonsoft.Json.JsonProperty("order_ip")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("plat_account")]

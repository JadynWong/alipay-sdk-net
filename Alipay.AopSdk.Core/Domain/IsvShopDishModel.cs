...
namespace Aop.Api.Domain
{
    ...
    public class IsvShopDishModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("dish_type_id")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("dish_type_name")]
        public string DishTypeName { get; set; }

        /// <summary>
        /// 菜品热度等级（0/0.5/1/1.5/2/2.5/3/3.5/4/4.5/5）该字段是对sort_col做离散化，数字越大越热
        /// </summary>
        [Newtonsoft.Json.JsonProperty("good_level")]
        public string GoodLevel { get; set; }

        /// <summary>
        /// 当前店铺的商家最近7天销量（份）
        /// </summary>
        [Newtonsoft.Json.JsonProperty("merchant_sold_cnt_seven_d")]
        public long MerchantSoldCntSevenD { get; set; }

        /// <summary>
        /// 当前店铺的商家最近30天销量（份）
        /// </summary>
        [Newtonsoft.Json.JsonProperty("merchant_sold_cnt_thirty_d")]
        public long MerchantSoldCntThirtyD { get; set; }

        /// <summary>
        /// 当前店铺的商家最近30天购买2次及以上的支付宝用户数
        /// </summary>
        [Newtonsoft.Json.JsonProperty("merchant_sold_reusercnt_thirty_d")]
        public long MerchantSoldReusercntThirtyD { get; set; }

        /// <summary>
        /// 当前店铺的商家最近30天消费支付宝用户数
        /// </summary>
        [Newtonsoft.Json.JsonProperty("merchant_sold_usercnt_thirty_d")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("outer_dish_id")]
        public string OuterDishId { get; set; }

        /// <summary>
        /// 废弃，请ISV使用自己的图
        /// </summary>
        [Newtonsoft.Json.JsonProperty("pict")]
        ...
        /// 当前店铺最近7天销量（份）
        /// </summary>
        [Newtonsoft.Json.JsonProperty("sold_cnt_seven_d")]
        public long SoldCntSevenD { get; set; }

        /// <summary>
        /// 当前店铺最近30天销量（份）
        /// </summary>
        [Newtonsoft.Json.JsonProperty("sold_cnt_thirty_d")]
        public long SoldCntThirtyD { get; set; }

        /// <summary>
        /// 当前店铺最近30天购买2次及以上的支付宝用户数
        /// </summary>
        [Newtonsoft.Json.JsonProperty("sold_reusercnt_thirty_d")]
        public long SoldReusercntThirtyD { get; set; }

        /// <summary>
        /// 当前店铺最近30天消费支付宝用户数
        /// </summary>
        [Newtonsoft.Json.JsonProperty("sold_usercnt_thirty_d")]

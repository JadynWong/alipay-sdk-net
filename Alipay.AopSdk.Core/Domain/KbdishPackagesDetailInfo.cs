...
namespace Aop.Api.Domain
{
    ...
    public class KbdishPackagesDetailInfo : AopObject
    {
        ...
        /// 明细菜品在套餐里的个数, 不填默认为1
        /// </summary>
        [Newtonsoft.Json.JsonProperty("detail_count")]
        public string DetailCount { get; set; }

        /// <summary>
        /// 是否追加可选 Y .N  明细是否追加可选
        /// </summary>
        [Newtonsoft.Json.JsonProperty("detail_is_select")]
        public string DetailIsSelect { get; set; }

        /// <summary>
        /// 明细菜品的会员价格单价
        /// </summary>
        [Newtonsoft.Json.JsonProperty("detail_member_price")]
        public string DetailMemberPrice { get; set; }

        /// <summary>
        /// 明细菜品在套餐里的售卖单价
        /// </summary>
        [Newtonsoft.Json.JsonProperty("detail_sell_price")]
        public string DetailSellPrice { get; set; }

        /// <summary>
        /// 套餐明细的skuId
        /// </summary>
        [Newtonsoft.Json.JsonProperty("detail_sku_id")]
        public string DetailSkuId { get; set; }

        /// <summary>
        /// 排序字段 必输 仅为数字 越小排在前面
        /// </summary>
        [Newtonsoft.Json.JsonProperty("detail_sort")]
        ...
        /// 套餐的sku_code
        /// </summary>
        [Newtonsoft.Json.JsonProperty("packages_sku_id")]

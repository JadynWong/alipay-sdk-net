...
namespace Aop.Api.Domain
{
    ...
    public class AlipaySocialBaseMcommentNewsfeedAddModel : AopObject
    {
        ...
        /// 活动地点名称
        /// </summary>
        [Newtonsoft.Json.JsonProperty("activity_address")]
        ...
        /// 动态关联的现场id
        /// </summary>
        [Newtonsoft.Json.JsonProperty("aid")]
        ...
        /// 动态的标题信息
        /// </summary>
        [Newtonsoft.Json.JsonProperty("label_info")]
        ...
        /// 动态相关的地理位置（发给现场的动态必填）
        /// </summary>
        [Newtonsoft.Json.JsonProperty("location_info")]
        public NewsfeedLocationInfo LocationInfo { get; set; }

        /// <summary>
        /// 地理位置名称
        /// </summary>
        [Newtonsoft.Json.JsonProperty("location_name")]
        public string LocationName { get; set; }

        /// <summary>
        /// 地理位置跳转链接（当前支持https和alipay开头）
        /// </summary>
        [Newtonsoft.Json.JsonProperty("location_scheme")]
        ...
        /// 用于标识来源app的图标
        /// </summary>
        [Newtonsoft.Json.JsonProperty("source_icon")]
        public string SourceIcon { get; set; }

        /// <summary>
        /// 用于标识来源APP的名称
        /// </summary>
        [Newtonsoft.Json.JsonProperty("source_name")]
        public string SourceName { get; set; }

        /// <summary>
        /// 个人动态扩散范围：0只生活圈，  1只现场，2既有生活圈也有现场
        /// </summary>
        [Newtonsoft.Json.JsonProperty("spread_range")]

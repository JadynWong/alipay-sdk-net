...
namespace Aop.Api.Domain
{
    ...
    public class InfoSecHitDetectItem : AopObject
    {
        ...
        /// 级别
        /// </summary>
        [Newtonsoft.Json.JsonProperty("detect_resource_level")]

...
namespace Aop.Api.Domain
{
    ...
    public class AlipayEcoMedicalcareHosRegnotifyModel : AopObject
    {
        ...
        /// 撤销说明
        /// </summary>
        [Newtonsoft.Json.JsonProperty("cancel_desc")]
        ...
        /// 科室信息
        /// </summary>
        [Newtonsoft.Json.JsonProperty("dept_info")]
        public MedicalHospitalDeptInfo DeptInfo { get; set; }

        /// <summary>
        /// 医生信息
        /// </summary>
        [Newtonsoft.Json.JsonProperty("doctor_info")]
        ...
        /// 医院信息
        /// </summary>
        [Newtonsoft.Json.JsonProperty("hos_info")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("order_link")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("reg_link")]
        public string RegLink { get; set; }

        /// <summary>
        /// 第三方唯一序列号（可以是订单号确保唯一）
        /// </summary>
        [Newtonsoft.Json.JsonProperty("third_no")]
        public string ThirdNo { get; set; }

        /// <summary>
        /// 就诊日期 格式为yyyy-MM-dd HH:mm:ss。
        /// </summary>
        [Newtonsoft.Json.JsonProperty("treat_date")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("treat_date_ext")]

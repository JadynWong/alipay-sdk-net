...
namespace Aop.Api.Domain
{
    ...
    public class MerchantCard : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("biz_card_no")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("front_image_id")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("mdcode_info")]
        public MdCodeInfoDTO MdcodeInfo { get; set; }

        /// <summary>
        /// 会员卡开卡时间，格式为yyyy-MM-dd HH:mm:ss
        /// </summary>
        [Newtonsoft.Json.JsonProperty("open_date")]

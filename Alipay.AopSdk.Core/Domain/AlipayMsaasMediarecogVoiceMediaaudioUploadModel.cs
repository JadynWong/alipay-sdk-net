...
namespace Aop.Api.Domain
{
    ...
    public class AlipayMsaasMediarecogVoiceMediaaudioUploadModel : AopObject
    {
        ...
        /// 扩展字段
        /// </summary>
        [Newtonsoft.Json.JsonProperty("extinfo_c")]
        public string ExtinfoC { get; set; }

        /// <summary>
        /// 扩展字段
        /// </summary>
        [Newtonsoft.Json.JsonProperty("extinfo_d")]
        public string ExtinfoD { get; set; }

        /// <summary>
        /// 时间戳
        /// </summary>
        [Newtonsoft.Json.JsonProperty("labeltime")]
        public string Labeltime { get; set; }

        /// <summary>
        /// 媒体名称
        /// </summary>
        [Newtonsoft.Json.JsonProperty("vname")]
        public string Vname { get; set; }

        /// <summary>
        /// 媒体类型
        /// </summary>
        [Newtonsoft.Json.JsonProperty("vtype")]

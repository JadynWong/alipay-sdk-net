...
namespace Aop.Api.Domain
{
    ...
    public class AlipayOverseasTaxOrderPayModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("available_day")]
        public long AvailableDay { get; set; }

        /// <summary>
        /// 业务模式，目前暂只支持 FOREX_TAX_REFUND (外币退税)
        /// </summary>
        [Newtonsoft.Json.JsonProperty("biz_mode")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("confirm_date")]
        ...
        /// 出境口岸
        /// </summary>
        [Newtonsoft.Json.JsonProperty("departure_point")]
        public string DeparturePoint { get; set; }

        /// <summary>
        /// 退税单过期时间，退税单据的有效期是6个月，退税打印时间+6个月，格式 : yyyy-MM-dd HH:mm:ss，北京时间24小时制，时区东八区
        /// </summary>
        [Newtonsoft.Json.JsonProperty("doc_expire_date")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("identify_account_no")]
        public string IdentifyAccountNo { get; set; }

        /// <summary>
        /// 支付宝账号标识类型，  条码退税，取值：barcode
        /// </summary>
        [Newtonsoft.Json.JsonProperty("identify_account_type")]
        ...
        /// 护照姓名，用户护照上的英文姓名
        /// </summary>
        [Newtonsoft.Json.JsonProperty("passport_name")]
        public string PassportName { get; set; }

        /// <summary>
        /// 护照号，退税客人的护照号
        /// </summary>
        [Newtonsoft.Json.JsonProperty("passport_no")]
        public string PassportNo { get; set; }

        /// <summary>
        /// 购物金额，退税单上的购物金额，为数字格式，精确到币种最小单位，币种由sales_currency指定，如sales_currency为SGD，币种最小单位为分，100元新币，则sales_amount传入10000.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("sales_amount")]
        public string SalesAmount { get; set; }

        /// <summary>
        /// 购物币种，ISO标准购物国家alpha-3币种代码
        /// </summary>
        [Newtonsoft.Json.JsonProperty("sales_currency")]
        public string SalesCurrency { get; set; }

        /// <summary>
        /// 购物时间，格式 : yyyy-MM-dd HH:mm:ss，北京时间24小时制，时区东八区
        /// </summary>
        [Newtonsoft.Json.JsonProperty("sales_date")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("user_received_amount")]
        public string UserReceivedAmount { get; set; }

        /// <summary>
        /// 用户实际收款币种，一般指人民币 CNY，ISO标准退税国家alpha-3币种代码
        /// </summary>
        [Newtonsoft.Json.JsonProperty("user_received_currency")]

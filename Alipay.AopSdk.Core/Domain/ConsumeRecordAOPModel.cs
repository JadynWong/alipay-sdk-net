...
namespace Aop.Api.Domain
{
    ...
    public class ConsumeRecordAOPModel : AopObject
    {
        ...
        /// 扩展状态
        /// </summary>
        [Newtonsoft.Json.JsonProperty("additional_status")]
        ...
        /// 业务扩展流水号
        /// </summary>
        [Newtonsoft.Json.JsonProperty("biz_extra_no")]
        ...
        /// 业务备注
        /// </summary>
        [Newtonsoft.Json.JsonProperty("biz_memo")]
        public string BizMemo { get; set; }

        /// <summary>
        /// 业务发起方
        /// </summary>
        [Newtonsoft.Json.JsonProperty("biz_orig")]
        ...
        /// 业务子类型
        /// </summary>
        [Newtonsoft.Json.JsonProperty("biz_sub_type")]
        ...
        /// 消费记录退款状态
        /// </summary>
        [Newtonsoft.Json.JsonProperty("consume_refund_status")]
        public string ConsumeRefundStatus { get; set; }

        /// <summary>
        /// 来源
        /// </summary>
        [Newtonsoft.Json.JsonProperty("consume_site")]
        public string ConsumeSite { get; set; }

        /// <summary>
        /// 消费记录状态
        /// </summary>
        [Newtonsoft.Json.JsonProperty("consume_status")]
        public string ConsumeStatus { get; set; }

        /// <summary>
        /// 标题
        /// </summary>
        [Newtonsoft.Json.JsonProperty("consume_title")]
        public string ConsumeTitle { get; set; }

        /// <summary>
        /// 消费记录类型
        /// </summary>
        [Newtonsoft.Json.JsonProperty("consume_type")]
        ...
        /// 消费记录永久删除时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("delete_over_time")]
        ...
        /// 消费记录删除标记
        /// </summary>
        [Newtonsoft.Json.JsonProperty("delete_type")]
        public string DeleteType { get; set; }

        /// <summary>
        /// 充退状态，可能为空，目前只针对交易业务有效
        /// </summary>
        [Newtonsoft.Json.JsonProperty("depositback_status")]
        public string DepositbackStatus { get; set; }

        /// <summary>
        /// 是否锁定标记
        /// </summary>
        [Newtonsoft.Json.JsonProperty("flag_locked")]
        public string FlagLocked { get; set; }

        /// <summary>
        /// 退款标记
        /// </summary>
        [Newtonsoft.Json.JsonProperty("flag_refund")]
        ...
        /// 业务数据最后更新时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("gmt_biz_modified")]
        ...
        /// 收到付款时间（买家付款时间）
        /// </summary>
        [Newtonsoft.Json.JsonProperty("gmt_receive_pay")]
        public string GmtReceivePay { get; set; }

        /// <summary>
        /// 打款给卖家时间（卖家收款时间）
        /// </summary>
        [Newtonsoft.Json.JsonProperty("gmt_send_pay")]
        public string GmtSendPay { get; set; }

        /// <summary>
        /// 是否有资金明细
        /// </summary>
        [Newtonsoft.Json.JsonProperty("has_fund_item")]
        public bool HasFundItem { get; set; }

        /// <summary>
        /// 是否有新资金明细(落地新流程交易的消费记录)
        /// </summary>
        [Newtonsoft.Json.JsonProperty("has_new_fund_item")]
        public bool HasNewFundItem { get; set; }

        /// <summary>
        /// 收入/支出
        /// </summary>
        [Newtonsoft.Json.JsonProperty("in_out")]
        public string InOut { get; set; }

        /// <summary>
        /// 对方卡号
        /// </summary>
        [Newtonsoft.Json.JsonProperty("opposite_card_no")]
        public string OppositeCardNo { get; set; }

        /// <summary>
        /// 对方登录ID
        /// </summary>
        [Newtonsoft.Json.JsonProperty("opposite_login_id")]
        ...
        /// 对方昵称
        /// </summary>
        [Newtonsoft.Json.JsonProperty("opposite_nick_name")]
        public string OppositeNickName { get; set; }

        /// <summary>
        /// 消费记录原标题
        /// </summary>
        [Newtonsoft.Json.JsonProperty("orig_consume_title")]
        ...
        /// 本方客户ID
        /// </summary>
        [Newtonsoft.Json.JsonProperty("owner_customer_id")]
        public string OwnerCustomerId { get; set; }

        /// <summary>
        /// 本方登录ID
        /// </summary>
        [Newtonsoft.Json.JsonProperty("owner_login_id")]
        ...
        /// 本方昵称
        /// </summary>
        [Newtonsoft.Json.JsonProperty("owner_nick")]
        ...
        /// 代付人&亲密付人姓名
        /// </summary>
        [Newtonsoft.Json.JsonProperty("peerpayer_real_name")]
        ...
        /// 交易来源
        /// </summary>
        [Newtonsoft.Json.JsonProperty("trade_from")]

...
namespace Aop.Api.Domain
{
    ...
    public class InteligentGeneralMerchantPromo : AopObject
    {
        ...
        /// 圈人限制条件
        /// </summary>
        [Newtonsoft.Json.JsonProperty("crowd_constraint")]
        ...
        /// 活动预算
        /// </summary>
        [Newtonsoft.Json.JsonProperty("inteligent_budget")]
        public InteligentBudgetInfo InteligentBudget { get; set; }

        /// <summary>
        /// 活动限制信息
        /// </summary>
        [Newtonsoft.Json.JsonProperty("inteligent_constraint")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("merchant_promo_type")]

...
namespace Aop.Api.Domain
{
    ...
    public class ArrangementBaseVO : AopObject
    {
        ...
        /// 签约机构编码
        /// </summary>
        [Newtonsoft.Json.JsonProperty("arrangement_institution_code")]
        public string ArrangementInstitutionCode { get; set; }

        /// <summary>
        /// 合约名称
        /// </summary>
        [Newtonsoft.Json.JsonProperty("arrangement_name")]
        ...
        /// 合约类型
        /// </summary>
        [Newtonsoft.Json.JsonProperty("arrangement_type")]
        public string ArrangementType { get; set; }

        /// <summary>
        /// 合约版
        /// </summary>
        [Newtonsoft.Json.JsonProperty("arrangement_version")]
        public string ArrangementVersion { get; set; }

        /// <summary>
        /// 签约渠道来源
        /// </summary>
        [Newtonsoft.Json.JsonProperty("channel_code")]
        ...
        /// 预计合约失效时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("gmt_invalid_due")]
        public string GmtInvalidDue { get; set; }

        /// <summary>
        /// 合约签署时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("gmt_sign")]
        public string GmtSign { get; set; }

        /// <summary>
        /// 预计合约生效时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("gmt_vald_due")]
        public string GmtValdDue { get; set; }

        /// <summary>
        /// 合约版本时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("gmt_vrsn")]
        ...
        /// 修改人
        /// </summary>
        [Newtonsoft.Json.JsonProperty("last_moder")]
        ...
        /// 修改人类型
        /// </summary>
        [Newtonsoft.Json.JsonProperty("moder_type")]
        public string ModerType { get; set; }

        /// <summary>
        /// 签约产品外标
        /// </summary>
        [Newtonsoft.Json.JsonProperty("pd_mark")]
        ...
        /// ps(产品销售)编码
        /// </summary>
        [Newtonsoft.Json.JsonProperty("ps_code")]
        public string PsCode { get; set; }

        /// <summary>
        /// ps(产品销售)id
        /// </summary>
        [Newtonsoft.Json.JsonProperty("ps_id")]
        public string PsId { get; set; }

        /// <summary>
        /// 产品销售名称
        /// </summary>
        [Newtonsoft.Json.JsonProperty("ps_name")]
        ...
        /// 签约模板产品编码
        /// </summary>
        [Newtonsoft.Json.JsonProperty("template_prod_code")]
        public string TemplateProdCode { get; set; }

        /// <summary>
        /// 签约模板产品版本
        /// </summary>
        [Newtonsoft.Json.JsonProperty("template_prod_version")]

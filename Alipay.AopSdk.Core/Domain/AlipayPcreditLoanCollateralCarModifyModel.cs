...
namespace Aop.Api.Domain
{
    ...
    public class AlipayPcreditLoanCollateralCarModifyModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("car_brand_id")]
        public string CarBrandId { get; set; }

        /// <summary>
        /// 车辆品牌名称，合作机构提供的车型库
        /// </summary>
        [Newtonsoft.Json.JsonProperty("car_brand_name")]
        public string CarBrandName { get; set; }

        /// <summary>
        /// 车辆颜色（中文），合作机构提供的颜色范围，如：  米色，棕色，金色，紫色，巧克力色，黑色，蓝色，灰色，绿色，红色，橙色，白色，香槟色，银色，黄色
        /// </summary>
        [Newtonsoft.Json.JsonProperty("car_color")]

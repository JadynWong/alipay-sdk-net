...
namespace Aop.Api.Domain
{
    ...
    public class AlipayEcoLogisticsExpressOrderModifyModel : AopObject
    {
        ...
        /// 快递员支付宝帐号，快递员接单时选填
        /// </summary>
        [Newtonsoft.Json.JsonProperty("courier_alipay_account")]
        public string CourierAlipayAccount { get; set; }

        /// <summary>
        /// 员工号，快递员接单时必填
        /// </summary>
        [Newtonsoft.Json.JsonProperty("courier_emp_num")]
        public string CourierEmpNum { get; set; }

        /// <summary>
        /// 接单快递员头像文件二进制内容的BASE64编码串  头像格式为100X100的PNG图片
        /// </summary>
        [Newtonsoft.Json.JsonProperty("courier_head_img")]
        public string CourierHeadImg { get; set; }

        /// <summary>
        /// 身份证，快递员接单时选填
        /// </summary>
        [Newtonsoft.Json.JsonProperty("courier_id_card")]
        public string CourierIdCard { get; set; }

        /// <summary>
        /// 快递员手机号，快递员接单时必填
        /// </summary>
        [Newtonsoft.Json.JsonProperty("courier_mobile")]
        public string CourierMobile { get; set; }

        /// <summary>
        /// 快递员姓名，快递员接单时必填
        /// </summary>
        [Newtonsoft.Json.JsonProperty("courier_name")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("logis_merch_code")]
        ...
        /// 产品类型变更原因，产品类型变更时选填。
        /// </summary>
        [Newtonsoft.Json.JsonProperty("product_type_change_reason")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("product_type_code")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("refuse_code")]
        public string RefuseCode { get; set; }

        /// <summary>
        /// 快递公司拒绝接单原因描述，快递公司拒绝接单原因编码取值为R08时必填
        /// </summary>
        [Newtonsoft.Json.JsonProperty("refuse_desc")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("site_area_code")]
        ...
        /// 站点投诉电话，快递站点接单时选填
        /// </summary>
        [Newtonsoft.Json.JsonProperty("site_complain_tel")]
        public string SiteComplainTel { get; set; }

        /// <summary>
        /// 站点所在详细地址，快递站点接单时必填
        /// </summary>
        [Newtonsoft.Json.JsonProperty("site_detail_addr")]
        public string SiteDetailAddr { get; set; }

        /// <summary>
        /// 站点负责人手机号，快递站点接单时必填
        /// </summary>
        [Newtonsoft.Json.JsonProperty("site_leader_mobile")]
        public string SiteLeaderMobile { get; set; }

        /// <summary>
        /// 站点负责人，快递站点接单时必填
        /// </summary>
        [Newtonsoft.Json.JsonProperty("site_leader_name")]
        ...
        /// 运单号，已取件状态时必填
        /// </summary>
        [Newtonsoft.Json.JsonProperty("way_bill_no")]

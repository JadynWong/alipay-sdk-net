...
namespace Aop.Api.Domain
{
    ...
    public class AlipayEcoMycarCarmodelModifyModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("modify_type")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("serie_group")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("serie_id")]
        public string SerieId { get; set; }

        /// <summary>
        /// 支付宝车型库车系名称（modify_type参数的值为serie时此参数必填）
        /// </summary>
        [Newtonsoft.Json.JsonProperty("serie_name")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("serie_photo")]

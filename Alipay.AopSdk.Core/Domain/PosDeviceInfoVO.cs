...
namespace Aop.Api.Domain
{
    ...
    public class PosDeviceInfoVO : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("decive_software_name")]
        public string DeciveSoftwareName { get; set; }

        /// <summary>
        /// 设备安装的应用数
        /// </summary>
        [Newtonsoft.Json.JsonProperty("device_app_cnt")]
        public string DeviceAppCnt { get; set; }

        /// <summary>
        /// 设备安装的应用列表对应的流量,单位KB
        /// </summary>
        [Newtonsoft.Json.JsonProperty("device_app_flow")]
        public string DeviceAppFlow { get; set; }

        /// <summary>
        /// 设备安装的应用列表
        /// </summary>
        [Newtonsoft.Json.JsonProperty("device_app_list")]
        public string DeviceAppList { get; set; }

        /// <summary>
        /// 设备出厂公司；比如：商米；新大陆；荣焱；
        /// </summary>
        [Newtonsoft.Json.JsonProperty("device_company_name")]
        public string DeviceCompanyName { get; set; }

        /// <summary>
        /// 设备总使用流量,单位KB
        /// </summary>
        [Newtonsoft.Json.JsonProperty("device_flow")]
        ...
        /// pos机设备MAC地址
        /// </summary>
        [Newtonsoft.Json.JsonProperty("device_mac")]
        public string DeviceMac { get; set; }

        /// <summary>
        /// 设备运行的操作系统版本
        /// </summary>
        [Newtonsoft.Json.JsonProperty("device_os_version")]
        public string DeviceOsVersion { get; set; }

        /// <summary>
        /// pos机设备状态值，枚举值为：已出厂(1)，已入仓(2)，已出售(3)，已报单(4)，已发货(5)，已收货(6)，已激活(7)、已绑定(8)、运行中(9)、设备失联(10)、已解绑(11)
        /// </summary>
        [Newtonsoft.Json.JsonProperty("device_status")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("device_version")]
        public string DeviceVersion { get; set; }

        /// <summary>
        /// 设备激活时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("gmt_activate")]
        public string GmtActivate { get; set; }

        /// <summary>
        /// 最后登录时间:设备处于登陆状态的最后时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("gmt_login")]
        public string GmtLogin { get; set; }

        /// <summary>
        /// 设备解绑时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("gmt_production")]
        public string GmtProduction { get; set; }

        /// <summary>
        /// 最后发送信息时间:设备最后发送信息的时间，发给服务端的最后时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("gmt_send")]
        public string GmtSend { get; set; }

        /// <summary>
        /// 设备出厂时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("gmt_unbundling")]
        public string GmtUnbundling { get; set; }

        /// <summary>
        /// 最后更新时间:设备上软件的最后更新时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("gmt_update")]
        ...
        /// 设备id，唯一标识设备的ID,SN号
        /// </summary>
        [Newtonsoft.Json.JsonProperty("sn_no")]

...
namespace Aop.Api.Domain
{
    ...
    public class BatchFundItemAOPModel : AopObject
    {
        ...
        /// 退款到银行卡处理中的总金额
        /// </summary>
        [Newtonsoft.Json.JsonProperty("dback_refundtobank_processing_batch_amount")]
        public string DbackRefundtobankProcessingBatchAmount { get; set; }

        /// <summary>
        /// 退款到银行卡成功的总金额
        /// </summary>
        [Newtonsoft.Json.JsonProperty("dback_refundtobank_success_batch_amount")]
        ...
        /// 批次创建时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("gmt_biz_create_date")]
        ...
        /// 包含服务费的总金额
        /// </summary>
        [Newtonsoft.Json.JsonProperty("total_amount_with_service_fee")]

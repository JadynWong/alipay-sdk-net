...
namespace Aop.Api.Domain
{
    ...
    public class AlipayFundTransTobankTransferModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("time_liness")]

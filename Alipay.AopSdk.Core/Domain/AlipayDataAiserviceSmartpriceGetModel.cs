...
namespace Aop.Api.Domain
{
    ...
    public class AlipayDataAiserviceSmartpriceGetModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("base_price_cent")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("default_promo_price_cent")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("high_price_cent")]
        public long HighPriceCent { get; set; }

        /// <summary>
        /// 月卡售价区间范围的下限，单位为分，该参数取值为hellobike调用方自身的业务参数。
        /// </summary>
        [Newtonsoft.Json.JsonProperty("lower_price_cent")]

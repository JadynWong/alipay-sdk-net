...
namespace Aop.Api.Domain
{
    ...
    public class AlipayMsaasSyncSingledataSendModel : AopObject
    {
        ...
        /// 支持的最大客户端app版本号
        /// </summary>
        [Newtonsoft.Json.JsonProperty("app_max_version")]
        public string AppMaxVersion { get; set; }

        /// <summary>
        /// 支持的最小客户端app版本号
        /// </summary>
        [Newtonsoft.Json.JsonProperty("app_min_version")]
        public string AppMinVersion { get; set; }

        /// <summary>
        /// base64编码后的二进制业务数据，与payload二选一
        /// </summary>
        [Newtonsoft.Json.JsonProperty("binary_payload")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("client_app")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("immediate_sync")]
        public bool ImmediateSync { get; set; }

        /// <summary>
        /// 根据申请bizType决定，用户维度业务填写userId, 设备维度填写utdid
        /// </summary>
        [Newtonsoft.Json.JsonProperty("link_token")]
        public string LinkToken { get; set; }

        /// <summary>
        /// 指定接收数据的客户端os类型
        /// </summary>
        [Newtonsoft.Json.JsonProperty("os_type")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("third_msg_id")]

...
namespace Aop.Api.Domain
{
    ...
    public class InvoiceApplyOpenModel : AopObject
    {
        ...
        /// 操作员
        /// </summary>
        [Newtonsoft.Json.JsonProperty("clerk")]
        public string Clerk { get; set; }

        /// <summary>
        /// 不含税金额
        /// </summary>
        [Newtonsoft.Json.JsonProperty("ex_tax_amount")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("invoice_kind")]
        public string InvoiceKind { get; set; }

        /// <summary>
        /// 发票备注
        /// </summary>
        [Newtonsoft.Json.JsonProperty("invoice_memo")]
        ...
        /// 销售方地址
        /// </summary>
        [Newtonsoft.Json.JsonProperty("payee_address")]
        public string PayeeAddress { get; set; }

        /// <summary>
        /// 销售方开户账户
        /// </summary>
        [Newtonsoft.Json.JsonProperty("payee_bank_account")]
        public string PayeeBankAccount { get; set; }

        /// <summary>
        /// 销售方开户行
        /// </summary>
        [Newtonsoft.Json.JsonProperty("payee_bank_name")]
        public string PayeeBankName { get; set; }

        /// <summary>
        /// 销售方名称，对应于销售方纳税人识别号的名称
        /// </summary>
        [Newtonsoft.Json.JsonProperty("payee_register_name")]
        public string PayeeRegisterName { get; set; }

        /// <summary>
        /// 销售方纳税人识别号
        /// </summary>
        [Newtonsoft.Json.JsonProperty("payee_register_no")]
        public string PayeeRegisterNo { get; set; }

        /// <summary>
        /// 销售方电话
        /// </summary>
        [Newtonsoft.Json.JsonProperty("payee_tel")]
        public string PayeeTel { get; set; }

        /// <summary>
        /// 购买方联系方式-邮箱，商家开蓝票时，该字段必填，使用该邮箱向购买方发送发票pdf文件。其它情况均可不传
        /// </summary>
        [Newtonsoft.Json.JsonProperty("payer_contact_email")]
        public string PayerContactEmail { get; set; }

        /// <summary>
        /// 购买方联系方式，依据税控厂商的要求，如若底层税控对接的是浙江航信，该字段必传，其它情况可不传
        /// </summary>
        [Newtonsoft.Json.JsonProperty("payer_contact_mobile")]
        public string PayerContactMobile { get; set; }

        /// <summary>
        /// 合计税额
        /// </summary>
        [Newtonsoft.Json.JsonProperty("sum_tax_amount")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("tax_token")]
        public string TaxToken { get; set; }

        /// <summary>
        /// 交易发生时间,依据税控厂商要求，目前底层税控对接的是浙江航信的话，该字段必填
        /// </summary>
        [Newtonsoft.Json.JsonProperty("trade_date")]

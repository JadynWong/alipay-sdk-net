...
namespace Aop.Api.Domain
{
    ...
    public class ItemInfo : AopObject
    {
        ...
        /// 单品券详细介绍跳转链接
        /// </summary>
        [Newtonsoft.Json.JsonProperty("item_link")]

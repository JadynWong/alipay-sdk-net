...
namespace Aop.Api.Domain
{
    ...
    public class AlipayEcoLogisticsExpressPriceModifyModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("area_type")]
        public string AreaType { get; set; }

        /// <summary>
        /// 续重价格（单位：元）
        /// </summary>
        [Newtonsoft.Json.JsonProperty("extra_weight_price")]
        public string ExtraWeightPrice { get; set; }

        /// <summary>
        /// 续重单位（单位：克）
        /// </summary>
        [Newtonsoft.Json.JsonProperty("extra_weight_unit")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("from_code")]
        ...
        /// 首重重量（单位：克）
        /// </summary>
        [Newtonsoft.Json.JsonProperty("preset_weight")]
        public long PresetWeight { get; set; }

        /// <summary>
        /// 首重价格（单位：元）
        /// </summary>
        [Newtonsoft.Json.JsonProperty("preset_weight_price")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("to_code")]

...
namespace Aop.Api.Domain
{
    ...
    public class AlipayDataItemVoucherTemplete : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("delay_minute")]
        ...
        /// 外部单品列表
        /// </summary>
        [Newtonsoft.Json.JsonProperty("external_goods_list")]
        public AlipayDataItemGoodsList ExternalGoodsList { get; set; }

        /// <summary>
        /// 使用时间规则，控制商品的生效时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("limit_period_info_list")]
        ...
        /// 券原折扣
        /// </summary>
        [Newtonsoft.Json.JsonProperty("original_rate")]
        public string OriginalRate { get; set; }

        /// <summary>
        /// 单品代金券中的减至金额
        /// </summary>
        [Newtonsoft.Json.JsonProperty("reduce_to_amount")]
        ...
        /// 起步数量，用于指定可享受优惠的起步单品购买数量
        /// </summary>
        [Newtonsoft.Json.JsonProperty("threshold_quantity")]

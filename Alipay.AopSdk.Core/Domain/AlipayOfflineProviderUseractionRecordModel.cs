...
namespace Aop.Api.Domain
{
    ...
    public class AlipayOfflineProviderUseractionRecordModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("action_detail")]
        public string ActionDetail { get; set; }

        /// <summary>
        /// 每次请求的唯一id，需开发者自行保证此参数值每次请求的唯一性。后续可以通过当前唯一id进行问题排查。
        /// </summary>
        [Newtonsoft.Json.JsonProperty("action_outer_id")]
        ...
        /// 废弃，不需要设置
        /// </summary>
        [Newtonsoft.Json.JsonProperty("alipay_app_id")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("outer_shop_do")]
        public OuterShopDO OuterShopDo { get; set; }

        /// <summary>
        /// 废弃，不需要设置
        /// </summary>
        [Newtonsoft.Json.JsonProperty("platform_user_id")]

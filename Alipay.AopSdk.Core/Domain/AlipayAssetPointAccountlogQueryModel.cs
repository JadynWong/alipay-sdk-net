...
namespace Aop.Api.Domain
{
    ...
    public class AlipayAssetPointAccountlogQueryModel : AopObject
    {
        ...
        /// 用户流水查询起始时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("account_date_begin")]
        public string AccountDateBegin { get; set; }

        /// <summary>
        /// 用户流水查询结束时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("account_date_end")]

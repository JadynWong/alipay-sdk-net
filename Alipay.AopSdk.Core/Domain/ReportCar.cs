...
namespace Aop.Api.Domain
{
    ...
    public class ReportCar : AopObject
    {
        ...
        /// 定损员信息，核赔阶段标的车必填
        /// </summary>
        [Newtonsoft.Json.JsonProperty("assessor")]
        ...
        /// 修理厂地址
        /// </summary>
        [Newtonsoft.Json.JsonProperty("garage_address")]
        public string GarageAddress { get; set; }

        /// <summary>
        /// 修理厂名称
        /// </summary>
        [Newtonsoft.Json.JsonProperty("garage_name")]
        public string GarageName { get; set; }

        /// <summary>
        /// 修理厂手机号
        /// </summary>
        [Newtonsoft.Json.JsonProperty("garage_phone_no")]
        public string GaragePhoneNo { get; set; }

        /// <summary>
        /// 修理厂类型  4S:4S店  GENERAL:综合修理
        /// </summary>
        [Newtonsoft.Json.JsonProperty("garage_type")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("survey_first_commit_date")]
        public string SurveyFirstCommitDate { get; set; }

        /// <summary>
        /// 查勘末次时间，标准时间格式：yyyy-MM-dd HH:mm:ss
        /// </summary>
        [Newtonsoft.Json.JsonProperty("survey_last_commit_date")]
        public string SurveyLastCommitDate { get; set; }

        /// <summary>
        /// 查勘员，查勘、核赔阶段标的车必填
        /// </summary>
        [Newtonsoft.Json.JsonProperty("surveyor")]

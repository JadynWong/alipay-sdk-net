...
namespace Aop.Api.Domain
{
    ...
    public class InvoiceItemQueryOpenModel : AopObject
    {
        ...
        /// 不含税金额
        /// </summary>
        [Newtonsoft.Json.JsonProperty("item_ex_tax_amount")]
        ...
        /// 商品编号
        /// </summary>
        [Newtonsoft.Json.JsonProperty("item_no")]
        ...
        /// 商品型号
        /// </summary>
        [Newtonsoft.Json.JsonProperty("item_spec")]
        ...
        /// 税额
        /// </summary>
        [Newtonsoft.Json.JsonProperty("item_tax_amount")]
        public string ItemTaxAmount { get; set; }

        /// <summary>
        /// 税率
        /// </summary>
        [Newtonsoft.Json.JsonProperty("item_tax_rate")]
        public string ItemTaxRate { get; set; }

        /// <summary>
        /// 单位
        /// </summary>
        [Newtonsoft.Json.JsonProperty("item_unit")]
        public string ItemUnit { get; set; }

        /// <summary>
        /// 单价，格式：100.00。新版电子发票，折扣行此参数不能传，非折扣行必传
        /// </summary>
        [Newtonsoft.Json.JsonProperty("item_unit_price")]
        public string ItemUnitPrice { get; set; }

        /// <summary>
        /// 发票行性质。0表示正常行，1表示折扣行，2表示被折扣行。比如充电器单价100元，折扣10元，则明细为2行，充电器行性质为2，折扣行性质为1。如果充电器没有折扣，则值应为0。
        /// </summary>
        [Newtonsoft.Json.JsonProperty("row_type")]

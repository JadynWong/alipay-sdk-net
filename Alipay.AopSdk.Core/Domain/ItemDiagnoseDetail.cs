...
namespace Aop.Api.Domain
{
    ...
    public class ItemDiagnoseDetail : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("hot_grade")]
        ...
        /// 单位分
        /// </summary>
        [Newtonsoft.Json.JsonProperty("item_price")]
        public long ItemPrice { get; set; }

        /// <summary>
        /// 近90天消费的支付宝用户数
        /// </summary>
        [Newtonsoft.Json.JsonProperty("rec_ninety_consume_uid_cnt")]
        public long RecNinetyConsumeUidCnt { get; set; }

        /// <summary>
        /// 近90天购买2次及以上的支付宝用户数
        /// </summary>
        [Newtonsoft.Json.JsonProperty("rec_ninety_rebuy_uid_cnt")]
        public long RecNinetyRebuyUidCnt { get; set; }

        /// <summary>
        /// 近7天的销售金额
        /// </summary>
        [Newtonsoft.Json.JsonProperty("rec_seven_sale_amt")]
        public long RecSevenSaleAmt { get; set; }

        /// <summary>
        /// 近7天销售个数
        /// </summary>
        [Newtonsoft.Json.JsonProperty("rec_seven_sale_cnt")]
        public long RecSevenSaleCnt { get; set; }

        /// <summary>
        /// 近60天消费的支付
        /// </summary>
        [Newtonsoft.Json.JsonProperty("rec_sixty_consume_uid_cnt")]
        public long RecSixtyConsumeUidCnt { get; set; }

        /// <summary>
        /// 近60天购买2次及以上的支付宝用户数
        /// </summary>
        [Newtonsoft.Json.JsonProperty("rec_sixty_rebuy_uid_cnt")]
        public long RecSixtyRebuyUidCnt { get; set; }

        /// <summary>
        /// 近30天消费的支付宝用户数
        /// </summary>
        [Newtonsoft.Json.JsonProperty("rec_thirty_consume_uid_cnt")]
        public string RecThirtyConsumeUidCnt { get; set; }

        /// <summary>
        /// 近30天购买2次及以上的支付宝用户数
        /// </summary>
        [Newtonsoft.Json.JsonProperty("rec_thirty_rebuy_uid_cnt")]
        public long RecThirtyRebuyUidCnt { get; set; }

        /// <summary>
        /// 近30天销售金额，单位分
        /// </summary>
        [Newtonsoft.Json.JsonProperty("rec_thirty_sale_amt")]
        public long RecThirtySaleAmt { get; set; }

        /// <summary>
        /// 近30天销售个数
        /// </summary>
        [Newtonsoft.Json.JsonProperty("rec_thirty_sale_cnt")]

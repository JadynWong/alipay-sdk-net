...
namespace Aop.Api.Domain
{
    ...
    public class CustomsDeclareRecordInfo : AopObject
    {
        ...
        /// 支付宝报关流水号。
        /// </summary>
        [Newtonsoft.Json.JsonProperty("alipay_declare_no")]
        ...
        /// 此记录所报关的海关编号，参见“海关编号”。
        /// </summary>
        [Newtonsoft.Json.JsonProperty("customs_place")]
        ...
        /// 商户在海关备案的编号。
        /// </summary>
        [Newtonsoft.Json.JsonProperty("merchant_customs_code")]
        public string MerchantCustomsCode { get; set; }

        /// <summary>
        /// 商户海关备案名称
        /// </summary>
        [Newtonsoft.Json.JsonProperty("merchant_customs_name")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("sub_out_biz_no")]

...
namespace Aop.Api.Domain
{
    ...
    public class ExtendMedicalCard : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("card_org_name")]

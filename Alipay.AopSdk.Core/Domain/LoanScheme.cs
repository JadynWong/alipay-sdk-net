...
namespace Aop.Api.Domain
{
    ...
    public class LoanScheme : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("credit_expire_date")]
        public string CreditExpireDate { get; set; }

        /// <summary>
        /// 授信额度，默认人民币，精确到小数点两位，单位元
        /// </summary>
        [Newtonsoft.Json.JsonProperty("credit_lmt_amt")]
        ...
        /// 授信方式
        /// </summary>
        [Newtonsoft.Json.JsonProperty("credit_source")]
        public string CreditSource { get; set; }

        /// <summary>
        /// 授信有效起始日期(日期精度为天,包含起始日)
        /// </summary>
        [Newtonsoft.Json.JsonProperty("credit_start_date")]
        public string CreditStartDate { get; set; }

        /// <summary>
        /// 利率. 年利率小数
        /// </summary>
        [Newtonsoft.Json.JsonProperty("int_rate")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("loanable_amt")]
        public string LoanableAmt { get; set; }

        /// <summary>
        /// 统一还款日，若无统一还款日，则为空
        /// </summary>
        [Newtonsoft.Json.JsonProperty("repay_day")]
        ...
        /// 销售产品版本
        /// </summary>
        [Newtonsoft.Json.JsonProperty("sale_pd_version")]

...
namespace Aop.Api.Domain
{
    ...
    public class AlipayCreditCreditriskDataPutModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("dataorgid")]
        public string Dataorgid { get; set; }

        /// <summary>
        /// 数据提供者,ISV注册成为网商银行的会员，达成数据合作服务，约定数据模型，由网商分配给ISV的机构代号
        /// </summary>
        [Newtonsoft.Json.JsonProperty("dataprovider")]
        public string Dataprovider { get; set; }

        /// <summary>
        /// 实体编码(ISV客户的支付宝数字ID)
        /// </summary>
        [Newtonsoft.Json.JsonProperty("entitycode")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("objectcontent")]

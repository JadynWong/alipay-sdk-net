...
namespace Aop.Api.Domain
{
    ...
    public class CPBillSet : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("relate_id")]
        public string RelateId { get; set; }

        /// <summary>
        /// 出账日期，格式固定为YYYYMMDD。
        /// </summary>
        [Newtonsoft.Json.JsonProperty("release_day")]

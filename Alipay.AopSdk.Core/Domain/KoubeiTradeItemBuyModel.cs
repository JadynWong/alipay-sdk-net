...
namespace Aop.Api.Domain
{
    ...
    public class KoubeiTradeItemBuyModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("buyer_phone_number")]
        public string BuyerPhoneNumber { get; set; }

        /// <summary>
        /// 预定的买家用户名称；该字段仅用于商品预定，商品预定场景下为必填字段
        /// </summary>
        [Newtonsoft.Json.JsonProperty("buyer_user_name")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("reserve_end_time")]
        public string ReserveEndTime { get; set; }

        /// <summary>
        /// 预定开始时间；该字段仅用于商品预定，商品预定场景下为必填字段  格式：yyyy-MM-dd HH:mm:ss
        /// </summary>
        [Newtonsoft.Json.JsonProperty("reserve_start_time")]

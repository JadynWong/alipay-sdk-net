...
namespace Aop.Api.Domain
{
    ...
    public class MpPrizeInfoModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("prize_max_award_limit")]
        ...
        /// 奖品总数量，数值，最大999999
        /// </summary>
        [Newtonsoft.Json.JsonProperty("prize_total")]

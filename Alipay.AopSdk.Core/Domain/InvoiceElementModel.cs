...
namespace Aop.Api.Domain
{
    ...
    public class InvoiceElementModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("expense_status")]
        public string ExpenseStatus { get; set; }

        /// <summary>
        /// 发票是否有pdf文件
        /// </summary>
        [Newtonsoft.Json.JsonProperty("has_pdf_file")]
        ...
        /// 销方税号
        /// </summary>
        [Newtonsoft.Json.JsonProperty("payee_tax_no")]
        ...
        /// 购方税号
        /// </summary>
        [Newtonsoft.Json.JsonProperty("payer_tax_no")]

...
namespace Aop.Api.Domain
{
    ...
    public class AlipayAssetCardNewtemplateCreateModel : AopObject
    {
        ...
        /// 账户模式：借记/贷记/借贷合一账户模式
        /// </summary>
        [Newtonsoft.Json.JsonProperty("account_model")]
        public string AccountModel { get; set; }

        /// <summary>
        /// 按照资金产品维度定义的资产类型
        /// </summary>
        [Newtonsoft.Json.JsonProperty("assets_code")]
        ...
        /// 卡模式：单卡/多卡模式
        /// </summary>
        [Newtonsoft.Json.JsonProperty("card_model")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("credit_info")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("settle_user_id")]

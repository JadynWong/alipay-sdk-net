...
namespace Aop.Api.Domain
{
    ...
    public class AlipayMarketingSharetokenCreateModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("btn_left")]
        public string BtnLeft { get; set; }

        /// <summary>
        /// 吱口令解码面板上左下方按钮的连接。一般不建议传值，默认行为是关闭吱口令面板
        /// </summary>
        [Newtonsoft.Json.JsonProperty("btn_left_href")]
        public string BtnLeftHref { get; set; }

        /// <summary>
        /// 吱口令解码面板上的右下方按钮文案
        /// </summary>
        [Newtonsoft.Json.JsonProperty("btn_right")]
        public string BtnRight { get; set; }

        /// <summary>
        /// 吱口令解码面板上右下方按钮的链接、一般是活动页面或业务跳转地址
        /// </summary>
        [Newtonsoft.Json.JsonProperty("btn_right_href")]

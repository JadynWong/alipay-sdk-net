...
namespace Aop.Api.Domain
{
    ...
    public class AlipayEcoMycarParkingParkinglotinfoCreateModel : AopObject
    {
        ...
        /// 该参数废弃
        /// </summary>
        [Newtonsoft.Json.JsonProperty("contact_alipay")]
        public string ContactAlipay { get; set; }

        /// <summary>
        /// 该参数废弃
        /// </summary>
        [Newtonsoft.Json.JsonProperty("contact_emali")]
        ...
        /// 该参数废弃
        /// </summary>
        [Newtonsoft.Json.JsonProperty("equipment_name")]
        ...
        /// 停车场地址
        /// </summary>
        [Newtonsoft.Json.JsonProperty("parking_address")]
        public string ParkingAddress { get; set; }

        /// <summary>
        /// 该参数废弃
        /// </summary>
        [Newtonsoft.Json.JsonProperty("parking_end_time")]
        public string ParkingEndTime { get; set; }

        /// <summary>
        /// 收费说明
        /// </summary>
        [Newtonsoft.Json.JsonProperty("parking_fee_description")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("parking_lot_type")]
        public string ParkingLotType { get; set; }

        /// <summary>
        /// 停车场客服电话
        /// </summary>
        [Newtonsoft.Json.JsonProperty("parking_mobile")]
        ...
        /// 该参数废弃
        /// </summary>
        [Newtonsoft.Json.JsonProperty("parking_number")]
        public string ParkingNumber { get; set; }

        /// <summary>
        /// 高德地图唯一标识
        /// </summary>
        [Newtonsoft.Json.JsonProperty("parking_poiid")]
        public string ParkingPoiid { get; set; }

        /// <summary>
        /// 该参数废弃
        /// </summary>
        [Newtonsoft.Json.JsonProperty("parking_start_time")]
        public string ParkingStartTime { get; set; }

        /// <summary>
        /// 该参数废弃
        /// </summary>
        [Newtonsoft.Json.JsonProperty("parking_type")]
        ...
        /// 商圈id
        /// </summary>
        [Newtonsoft.Json.JsonProperty("shopingmall_id")]

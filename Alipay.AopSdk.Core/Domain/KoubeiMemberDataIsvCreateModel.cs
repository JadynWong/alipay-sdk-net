...
namespace Aop.Api.Domain
{
    ...
    public class KoubeiMemberDataIsvCreateModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("gmt_member_card_last_active")]
        public string GmtMemberCardLastActive { get; set; }

        /// <summary>
        /// 会员卡领取时间（开卡时间），格式：yyyy-MM-dd HH:mm:ss
        /// </summary>
        [Newtonsoft.Json.JsonProperty("gmt_merber_card_create")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("member_card_type")]
        public string MemberCardType { get; set; }

        /// <summary>
        /// 会员用户身份识别ID
        /// </summary>
        [Newtonsoft.Json.JsonProperty("member_ship")]
        public MemberShip MemberShip { get; set; }

        /// <summary>
        /// 会员来源：  1：weixin（微信）；2：alipay（支付宝）；3：offline（线下会员卡）；4：other（其他）
        /// </summary>
        [Newtonsoft.Json.JsonProperty("member_source")]
        public string MemberSource { get; set; }

        /// <summary>
        /// 会员来源描述：如美团、饿了么等
        /// </summary>
        [Newtonsoft.Json.JsonProperty("member_source_desc")]
        public string MemberSourceDesc { get; set; }

        /// <summary>
        /// 会员状态：  1：生效；0：失效
        /// </summary>
        [Newtonsoft.Json.JsonProperty("member_status")]
        public string MemberStatus { get; set; }

        /// <summary>
        /// 外部记录
        /// </summary>
        [Newtonsoft.Json.JsonProperty("outer_member_info")]
        public OuterMemberInfo OuterMemberInfo { get; set; }

        /// <summary>
        /// 商户的PID
        /// </summary>
        [Newtonsoft.Json.JsonProperty("parter_id")]

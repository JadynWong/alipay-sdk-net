...
namespace Aop.Api.Domain
{
    ...
    public class InvoiceModelContent : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("extend_fields")]
        public string ExtendFields { get; set; }

        /// <summary>
        /// 下载的发票文件类型  可选值：  pdf（发票原文件）  jpg（发票原文件缩略图）
        /// </summary>
        [Newtonsoft.Json.JsonProperty("file_download_type")]
        public string FileDownloadType { get; set; }

        /// <summary>
        /// 文件下载地址，当同步发票tax_type=PLAIN时，必传；  此处的链接请务必传入可下载PDF的链接
        /// </summary>
        [Newtonsoft.Json.JsonProperty("file_download_url")]
        ...
        /// 发票防伪码
        /// </summary>
        [Newtonsoft.Json.JsonProperty("invoice_fake_code")]
        public string InvoiceFakeCode { get; set; }

        /// <summary>
        /// 原始发票PDF文件流
        /// </summary>
        [Newtonsoft.Json.JsonProperty("invoice_file_data")]
        public string InvoiceFileData { get; set; }

        /// <summary>
        /// 发票原始文件jpg文件地址
        /// </summary>
        [Newtonsoft.Json.JsonProperty("invoice_img_url")]
        ...
        /// 发票开具操作人
        /// </summary>
        [Newtonsoft.Json.JsonProperty("invoice_operator")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("original_blue_invoice_code")]
        public string OriginalBlueInvoiceCode { get; set; }

        /// <summary>
        /// 仅用于同步红票，原始蓝票发票号码，同步红票时必传
        /// </summary>
        [Newtonsoft.Json.JsonProperty("original_blue_invoice_no")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("out_invoice_id")]
        public string OutInvoiceId { get; set; }

        /// <summary>
        /// 开票单位地址
        /// </summary>
        [Newtonsoft.Json.JsonProperty("register_address")]
        public string RegisterAddress { get; set; }

        /// <summary>
        /// 开票单位开户行账号
        /// </summary>
        [Newtonsoft.Json.JsonProperty("register_bank_account")]
        public string RegisterBankAccount { get; set; }

        /// <summary>
        /// 开票单位开户行名称
        /// </summary>
        [Newtonsoft.Json.JsonProperty("register_bank_name")]
        public string RegisterBankName { get; set; }

        /// <summary>
        /// 开票单位
        /// </summary>
        [Newtonsoft.Json.JsonProperty("register_name")]
        ...
        /// 开票人电话，支持座机和手机两种格式
        /// </summary>
        [Newtonsoft.Json.JsonProperty("register_phone_no")]

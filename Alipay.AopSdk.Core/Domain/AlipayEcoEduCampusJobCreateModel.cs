...
namespace Aop.Api.Domain
{
    ...
    public class AlipayEcoEduCampusJobCreateModel : AopObject
    {
        ...
        /// 城市编码
        /// </summary>
        [Newtonsoft.Json.JsonProperty("area_city_code")]
        public string AreaCityCode { get; set; }

        /// <summary>
        /// 城市名称
        /// </summary>
        [Newtonsoft.Json.JsonProperty("area_city_name")]
        public string AreaCityName { get; set; }

        /// <summary>
        /// 区编码
        /// </summary>
        [Newtonsoft.Json.JsonProperty("area_district_code")]
        public string AreaDistrictCode { get; set; }

        /// <summary>
        /// 区名称
        /// </summary>
        [Newtonsoft.Json.JsonProperty("area_district_name")]
        public string AreaDistrictName { get; set; }

        /// <summary>
        /// 工作详细地址
        /// </summary>
        [Newtonsoft.Json.JsonProperty("area_job_address")]
        public string AreaJobAddress { get; set; }

        /// <summary>
        /// 省份编码（直辖市
        /// </summary>
        [Newtonsoft.Json.JsonProperty("area_province_code")]
        public long AreaProvinceCode { get; set; }

        /// <summary>
        /// 省份名称（直辖市）
        /// </summary>
        [Newtonsoft.Json.JsonProperty("area_province_name")]
        public string AreaProvinceName { get; set; }

        /// <summary>
        /// 街道名称
        /// </summary>
        [Newtonsoft.Json.JsonProperty("area_street_name")]
        ...
        /// 参数描述企业Logo
        /// </summary>
        [Newtonsoft.Json.JsonProperty("company_logo")]
        ...
        /// 第三方公司ID
        /// </summary>
        [Newtonsoft.Json.JsonProperty("company_source")]
        ...
        /// 职位描述
        /// </summary>
        [Newtonsoft.Json.JsonProperty("job_desc")]
        public string JobDesc { get; set; }

        /// <summary>
        /// 招聘人数
        /// </summary>
        [Newtonsoft.Json.JsonProperty("job_hire_number")]
        public long JobHireNumber { get; set; }

        /// <summary>
        /// 职位名称
        /// </summary>
        [Newtonsoft.Json.JsonProperty("job_name")]
        public string JobName { get; set; }

        /// <summary>
        /// 职业亮点/关键字
        /// </summary>
        [Newtonsoft.Json.JsonProperty("job_perk")]
        public string JobPerk { get; set; }

        /// <summary>
        /// 要求简历语言（1中文；2英文）
        /// </summary>
        [Newtonsoft.Json.JsonProperty("job_resume_lg")]
        public long JobResumeLg { get; set; }

        /// <summary>
        /// 学历要求专科（1:大专以下2:大专3:本科4:硕士5:博士6:其他7:不限）
        /// </summary>
        [Newtonsoft.Json.JsonProperty("job_rq_education")]
        public long JobRqEducation { get; set; }

        /// <summary>
        /// 职业一级分类code
        /// </summary>
        [Newtonsoft.Json.JsonProperty("job_tier_one_code")]
        public string JobTierOneCode { get; set; }

        /// <summary>
        /// 职业一级分类name
        /// </summary>
        [Newtonsoft.Json.JsonProperty("job_tier_one_name")]
        public string JobTierOneName { get; set; }

        /// <summary>
        /// 职业三级分类code
        /// </summary>
        [Newtonsoft.Json.JsonProperty("job_tier_three_code")]
        public string JobTierThreeCode { get; set; }

        /// <summary>
        /// 职业三级分类name
        /// </summary>
        [Newtonsoft.Json.JsonProperty("job_tier_three_name")]
        public string JobTierThreeName { get; set; }

        /// <summary>
        /// 职业二级分类code
        /// </summary>
        [Newtonsoft.Json.JsonProperty("job_tier_two_code")]
        public string JobTierTwoCode { get; set; }

        /// <summary>
        /// 职业二级分类name
        /// </summary>
        [Newtonsoft.Json.JsonProperty("job_tier_two_name")]
        ...
        /// 最大薪资（单位￥）
        /// </summary>
        [Newtonsoft.Json.JsonProperty("payment_max")]
        public long PaymentMax { get; set; }

        /// <summary>
        /// 最小薪资（单位￥）
        /// </summary>
        [Newtonsoft.Json.JsonProperty("payment_min")]
        public long PaymentMin { get; set; }

        /// <summary>
        /// 薪资单位(1:天2:月3:周)
        /// </summary>
        [Newtonsoft.Json.JsonProperty("payment_unit")]
        ...
        /// 每周到岗天数
        /// </summary>
        [Newtonsoft.Json.JsonProperty("tra_job_freq")]
        public long TraJobFreq { get; set; }

        /// <summary>
        /// 实习时间长度(单位月)
        /// </summary>
        [Newtonsoft.Json.JsonProperty("tra_job_period")]
        public long TraJobPeriod { get; set; }

        /// <summary>
        /// 是否可转正(1可以；0不可以)
        /// </summary>
        [Newtonsoft.Json.JsonProperty("tra_job_promot")]

...
namespace Aop.Api.Domain
{
    ...
    public class AlipayMarketingCardOpenModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("card_ext_info")]
        ...
        /// 发卡用户信息
        /// </summary>
        [Newtonsoft.Json.JsonProperty("card_user_info")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("open_card_channel")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("open_card_channel_id")]
        public string OpenCardChannelId { get; set; }

        /// <summary>
        /// 外部商户流水号（商户需要确保唯一性控制，类似request_id唯一请求标识）
        /// </summary>
        [Newtonsoft.Json.JsonProperty("out_serial_no")]

...
namespace Aop.Api.Domain
{
    ...
    public class OperatorInfo : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("operator_cert_indate")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("operator_cert_pic_back")]
        public string OperatorCertPicBack { get; set; }

        /// <summary>
        /// 个体工商户经营者证件正面照片（如证件类型为身份证则需要上传头像面图片）
        /// </summary>
        [Newtonsoft.Json.JsonProperty("operator_cert_pic_front")]

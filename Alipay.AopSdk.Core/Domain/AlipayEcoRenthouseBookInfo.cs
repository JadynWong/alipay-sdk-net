...
namespace Aop.Api.Domain
{
    ...
    public class AlipayEcoRenthouseBookInfo : AopObject
    {
        ...
        /// 定金金额
        /// </summary>
        [Newtonsoft.Json.JsonProperty("book_amount")]
        public string BookAmount { get; set; }

        /// <summary>
        /// 约定月租金额
        /// </summary>
        [Newtonsoft.Json.JsonProperty("book_sale_amount")]
        public string BookSaleAmount { get; set; }

        /// <summary>
        /// 约定最晚签约日格式 YYYY-MM-dd
        /// </summary>
        [Newtonsoft.Json.JsonProperty("latest_signing_date")]
        public string LatestSigningDate { get; set; }

        /// <summary>
        /// 约定租约开始时间格式 YYYY-MM-dd
        /// </summary>
        [Newtonsoft.Json.JsonProperty("lease_begin_date")]
        public string LeaseBeginDate { get; set; }

        /// <summary>
        /// 约定租约开始结束格式 YYYY-MM-dd
        /// </summary>
        [Newtonsoft.Json.JsonProperty("lease_end_date")]

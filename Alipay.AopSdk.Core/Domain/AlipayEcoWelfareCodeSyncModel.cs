...
namespace Aop.Api.Domain
{
    ...
    public class AlipayEcoWelfareCodeSyncModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("code_expire_date")]
        public string CodeExpireDate { get; set; }

        /// <summary>
        /// 条码数量
        /// </summary>
        [Newtonsoft.Json.JsonProperty("code_num")]
        public long CodeNum { get; set; }

        /// <summary>
        /// 条码图片url
        /// </summary>
        [Newtonsoft.Json.JsonProperty("code_pic_url")]
        public string CodePicUrl { get; set; }

        /// <summary>
        /// 条码可使用开发时间  格式为yyyy-MM-dd HH:mm:ss。
        /// </summary>
        [Newtonsoft.Json.JsonProperty("code_start_date")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("code_status_date")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("isv_code")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("sync_date")]
        public string SyncDate { get; set; }

        /// <summary>
        /// 福利平台订单对应的用户ID，和支付宝用户ID而选一
        /// </summary>
        [Newtonsoft.Json.JsonProperty("welfare_user_id")]

...
namespace Aop.Api.Domain
{
    ...
    public class AlipayFundTransBatchCreatesinglebatchModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("batch_memo")]

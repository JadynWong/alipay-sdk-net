...
namespace Aop.Api.Domain
{
    ...
    public class AlipayCommerceDataMonitordeviceQualitycenterModifyModel : AopObject
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("fault_type")]
        public string FaultType { get; set; }

        /// <summary>
        /// invoke_id, 用来回溯监控中心的调用方id，监控中心生成
        /// </summary>
        [Newtonsoft.Json.JsonProperty("invoke_id")]
        public long InvokeId { get; set; }

        /// <summary>
        /// quality_center_id，唯一，用于问题追踪去重，质量中心生成的唯一id。
        /// </summary>
        [Newtonsoft.Json.JsonProperty("quality_center_id")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("result_date")]

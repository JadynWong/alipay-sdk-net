...
namespace Aop.Api.Domain
{
    ...
    public class AlipayEcoEduKtBillingSendModel : AopObject
    {
        ...
        /// 缴费账单名称
        /// </summary>
        [Newtonsoft.Json.JsonProperty("charge_bill_title")]
        ...
        /// 学校编码，录入学校接口返回的参数
        /// </summary>
        [Newtonsoft.Json.JsonProperty("school_no")]

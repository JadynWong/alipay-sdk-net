...
namespace Aop.Api.Domain
{
    ...
    public class OpenPromoPrize : AopObject
    {
        ...
        /// 消费门槛设置，单位元
        /// </summary>
        [Newtonsoft.Json.JsonProperty("prize_base_rule_amount")]
        ...
        /// 奖品详情说明，默认和活动详情相同
        /// </summary>
        [Newtonsoft.Json.JsonProperty("prize_desc")]
        public string PrizeDesc { get; set; }

        /// <summary>
        /// ISV提供素材中心的图片ID
        /// </summary>
        [Newtonsoft.Json.JsonProperty("prize_detail_img")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("prize_end_time")]
        public string PrizeEndTime { get; set; }

        /// <summary>
        /// ISV提供素材中心的图片ID，建议尺寸120*120，默认为空
        /// </summary>
        [Newtonsoft.Json.JsonProperty("prize_logo")]
        public string PrizeLogo { get; set; }

        /// <summary>
        /// 奖品名称，默认和活动名称相同
        /// </summary>
        [Newtonsoft.Json.JsonProperty("prize_name")]
        public string PrizeName { get; set; }

        /// <summary>
        /// 券相可用对时间，和指定可用时间互斥。
        /// </summary>
        [Newtonsoft.Json.JsonProperty("prize_relative_time")]
        public OpenPromoPrizeRelativeTime PrizeRelativeTime { get; set; }

        /// <summary>
        /// 券指定可用开始时间，和相对可用时间互斥
        /// </summary>
        [Newtonsoft.Json.JsonProperty("prize_start_time")]
        public string PrizeStartTime { get; set; }

        /// <summary>
        /// 券副标题
        /// </summary>
        [Newtonsoft.Json.JsonProperty("prize_subtitle")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("prize_template_end_time")]
        public string PrizeTemplateEndTime { get; set; }

        /// <summary>
        /// 券模板有效起始日期，默认和活动开始时间相同
        /// </summary>
        [Newtonsoft.Json.JsonProperty("prize_template_start_time")]
        ...
        /// 抵扣金额，单位元。
        /// </summary>
        [Newtonsoft.Json.JsonProperty("prize_worth_amount")]

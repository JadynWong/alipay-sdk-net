...
namespace Aop.Api.Response
{
    ...
    public class AlipayOfflineMarketShopQuerydetailResponse : AopResponse
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("audit_images")]
        ...
        /// 授权函图片
        /// </summary>
        [Newtonsoft.Json.JsonProperty("auth_letter")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("box")]
        ...
        /// 经营许可证，只有餐饮类目需要
        /// </summary>
        [Newtonsoft.Json.JsonProperty("business_certificate")]
        public string BusinessCertificate { get; set; }

        /// <summary>
        /// 经营许可证有效期，格式：2020-03-20，只有餐饮类目需要
        /// </summary>
        [Newtonsoft.Json.JsonProperty("business_certificate_expires")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("create_channel")]
        ...
        /// 门店创建时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("gmt_shop_create")]
        public string GmtShopCreate { get; set; }

        /// <summary>
        /// 门店修改时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("gmt_shop_modified")]
        public string GmtShopModified { get; set; }

        /// <summary>
        /// 店铺使用的机具编号，多个以英文逗号分隔
        /// </summary>
        [Newtonsoft.Json.JsonProperty("implement_id")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("is_operating_online")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("isv_uid")]
        ...
        /// 门店营业执照编号
        /// </summary>
        [Newtonsoft.Json.JsonProperty("licence_code")]
        public string LicenceCode { get; set; }

        /// <summary>
        /// 营业执照过期时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("licence_expires")]
        public string LicenceExpires { get; set; }

        /// <summary>
        /// 门店营业执照名称
        /// </summary>
        [Newtonsoft.Json.JsonProperty("licence_name")]
        ...
        /// 其它资质证明图片集；支持多张，逗号分隔
        /// </summary>
        [Newtonsoft.Json.JsonProperty("other_auth_images")]
        public string OtherAuthImages { get; set; }

        /// <summary>
        /// 门店是否支持停车，T表示支持，F表示不支持，不传在客户端不作展示
        /// </summary>
        [Newtonsoft.Json.JsonProperty("parking")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("payment_account")]
        ...
        /// 经过加工后的门店收款二维码
        /// </summary>
        [Newtonsoft.Json.JsonProperty("processed_qr_code")]
        public string ProcessedQrCode { get; set; }

        /// <summary>
        /// 门店运营归属人uid
        /// </summary>
        [Newtonsoft.Json.JsonProperty("provider_xiaoer_uid")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("shop_tags")]
        ...
        /// 门店其他的服务，门店与用户线下兑现
        /// </summary>
        [Newtonsoft.Json.JsonProperty("value_added")]

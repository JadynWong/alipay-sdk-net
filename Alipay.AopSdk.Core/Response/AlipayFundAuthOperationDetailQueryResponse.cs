...
namespace Aop.Api.Response
{
    ...
    public class AlipayFundAuthOperationDetailQueryResponse : AopResponse
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("payer_logon_id")]
        public string PayerLogonId { get; set; }

        /// <summary>
        /// 付款方支付宝账号对应的支付宝唯一用户号，以2088开头的16位纯数字组成
        /// </summary>
        [Newtonsoft.Json.JsonProperty("payer_user_id")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("pre_auth_type")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("rest_amount")]
        ...
        /// 订单累计的冻结金额，单位为：元（人民币）
        /// </summary>
        [Newtonsoft.Json.JsonProperty("total_freeze_amount")]

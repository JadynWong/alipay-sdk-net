...
namespace Aop.Api.Response
{
    ...
    public class AlipayTradeRefundResponse : AopResponse
    {
        ...
        /// 本次退款是否发生了资金变化
        /// </summary>
        [Newtonsoft.Json.JsonProperty("fund_change")]
        public string FundChange { get; set; }

        /// <summary>
        /// 退款支付时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("gmt_refund_pay")]
        ...
        /// 退款币种信息
        /// </summary>
        [Newtonsoft.Json.JsonProperty("refund_currency")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("send_back_fee")]

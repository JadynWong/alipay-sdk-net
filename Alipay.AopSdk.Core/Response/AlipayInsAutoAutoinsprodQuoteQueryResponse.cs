...
namespace Aop.Api.Response
{
    ...
    public class AlipayInsAutoAutoinsprodQuoteQueryResponse : AopResponse
    {
        ...
        /// 商业险保费
        /// </summary>
        [Newtonsoft.Json.JsonProperty("business_premium")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("check_code_type")]
        public string CheckCodeType { get; set; }

        /// <summary>
        /// 保险公司ID
        /// </summary>
        [Newtonsoft.Json.JsonProperty("com_id")]
        public string ComId { get; set; }

        /// <summary>
        /// 保险公司简称
        /// </summary>
        [Newtonsoft.Json.JsonProperty("com_name")]
        ...
        /// 交强险保费
        /// </summary>
        [Newtonsoft.Json.JsonProperty("force_premium")]
        ...
        /// 报价失败错误码，这个很重要
        /// </summary>
        [Newtonsoft.Json.JsonProperty("quote_error_code")]
        public string QuoteErrorCode { get; set; }

        /// <summary>
        /// 报价失败提示信息
        /// </summary>
        [Newtonsoft.Json.JsonProperty("quote_error_msg")]
        public string QuoteErrorMsg { get; set; }

        /// <summary>
        /// 实付保费[优惠后用户应付金额]
        /// </summary>
        [Newtonsoft.Json.JsonProperty("real_premium")]
        public string RealPremium { get; set; }

        /// <summary>
        /// 优惠保费
        /// </summary>
        [Newtonsoft.Json.JsonProperty("reduce_premium")]

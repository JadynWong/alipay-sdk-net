...
namespace Aop.Api.Response
{
    ...
    public class AlipayUserInfoShareResponse : AopResponse
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("firm_type")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("graduation_time")]
        public string GraduationTime { get; set; }

        /// <summary>
        /// 余额账户是否被冻结。  T--被冻结；F--未冻结
        /// </summary>
        [Newtonsoft.Json.JsonProperty("is_balance_frozen")]
        ...
        /// 是否是学生
        /// </summary>
        [Newtonsoft.Json.JsonProperty("is_student_certified")]
        public string IsStudentCertified { get; set; }

        /// <summary>
        /// 营业执照有效期，yyyyMMdd或长期，（用户类型是公司类型时才有此字段）。
        /// </summary>
        [Newtonsoft.Json.JsonProperty("license_expiry_date")]
        ...
        /// 支付宝会员等级
        /// </summary>
        [Newtonsoft.Json.JsonProperty("member_grade")]
        ...
        /// 个人用户生日。
        /// </summary>
        [Newtonsoft.Json.JsonProperty("person_birthday")]
        public string PersonBirthday { get; set; }

        /// <summary>
        /// 证件有效期（用户类型是个人的时候才有此字段）。
        /// </summary>
        [Newtonsoft.Json.JsonProperty("person_cert_expiry_date")]
        ...
        /// 职业
        /// </summary>
        [Newtonsoft.Json.JsonProperty("profession")]

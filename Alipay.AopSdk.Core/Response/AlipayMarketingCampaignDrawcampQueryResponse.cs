...
namespace Aop.Api.Response
{
    ...
    public class AlipayMarketingCampaignDrawcampQueryResponse : AopResponse
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("cert_rule_id")]
        public string CertRuleId { get; set; }

        /// <summary>
        /// 单用户以账户证件号（如身份证号、护照、军官证等）维度可参与当前营销活动的总次数，由开发者自定义此数值
        /// </summary>
        [Newtonsoft.Json.JsonProperty("certification_count")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("crowd_rule_id")]
        public string CrowdRuleId { get; set; }

        /// <summary>
        /// 以认证手机号（与支付宝账号绑定的手机号）维度的可参与当前营销活动的总次数，由开发者自定义此数值
        /// </summary>
        [Newtonsoft.Json.JsonProperty("mobile_count")]
        ...
        /// 营销验证规则id，由支付宝配置
        /// </summary>
        [Newtonsoft.Json.JsonProperty("promo_rule_id")]
        ...
        /// 实时人群验证规则id，由支付宝配置
        /// </summary>
        [Newtonsoft.Json.JsonProperty("trigger_user_rule_id")]
        public string TriggerUserRuleId { get; set; }

        /// <summary>
        /// 人群验证规则id，由支付宝配置
        /// </summary>
        [Newtonsoft.Json.JsonProperty("user_rule_id")]

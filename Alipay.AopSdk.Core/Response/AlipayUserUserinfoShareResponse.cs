...
namespace Aop.Api.Response
{
    ...
    public class AlipayUserUserinfoShareResponse : AopResponse
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("balance_freeze_type")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("cert_type_value")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("firm_name")]
        ...
        /// T为是银行卡认证，F为非银行卡认证。
        /// </summary>
        [Newtonsoft.Json.JsonProperty("is_bank_auth")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("is_certify_grade_a")]
        public string IsCertifyGradeA { get; set; }

        /// <summary>
        /// T为是身份证认证，F为非身份证认证。
        /// </summary>
        [Newtonsoft.Json.JsonProperty("is_id_auth")]
        public string IsIdAuth { get; set; }

        /// <summary>
        /// T为通过营业执照认证，F为没有通过
        /// </summary>
        [Newtonsoft.Json.JsonProperty("is_licence_auth")]
        public string IsLicenceAuth { get; set; }

        /// <summary>
        /// T为是手机认证，F为非手机认证。
        /// </summary>
        [Newtonsoft.Json.JsonProperty("is_mobile_auth")]
        ...
        /// 生日的月和日，MMdd格式
        /// </summary>
        [Newtonsoft.Json.JsonProperty("reduced_birthday")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("user_type_value")]

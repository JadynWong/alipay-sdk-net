...
namespace Aop.Api.Response
{
    ...
    public class AlipayTradeQueryResponse : AopResponse
    {
        ...
        /// 支付宝店铺编号
        /// </summary>
        [Newtonsoft.Json.JsonProperty("alipay_store_id")]
        public string AlipayStoreId { get; set; }

        /// <summary>
        /// 预授权支付模式，该参数仅在信用预授权支付场景下返回。信用预授权支付：CREDIT_PREAUTH_PAY
        /// </summary>
        [Newtonsoft.Json.JsonProperty("auth_trade_pay_mode")]
        public string AuthTradePayMode { get; set; }

        /// <summary>
        /// 买家支付宝账号
        /// </summary>
        [Newtonsoft.Json.JsonProperty("buyer_logon_id")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("buyer_user_type")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("discount_goods_detail")]
        ...
        /// 商家优惠金额
        /// </summary>
        [Newtonsoft.Json.JsonProperty("mdiscount_amount")]
        ...
        /// 订单支付币种
        /// </summary>
        [Newtonsoft.Json.JsonProperty("pay_currency")]
        ...
        /// 本次交易打款给卖家的时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("send_pay_date")]
        ...
        /// 结算币种兑换标价币种汇率
        /// </summary>
        [Newtonsoft.Json.JsonProperty("settle_trans_rate")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("trade_status")]
        ...
        /// 标价币种兑换支付币种汇率
        /// </summary>
        [Newtonsoft.Json.JsonProperty("trans_pay_rate")]

...
namespace Aop.Api.Response
{
    ...
    public class KoubeiTradeTicketTicketcodeUseResponse : AopResponse
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("koubei_subsidy_amount")]
        ...
        /// 核销流水号
        /// </summary>
        [Newtonsoft.Json.JsonProperty("ticket_trans_id")]
        public string TicketTransId { get; set; }

        /// <summary>
        /// 券核销时间
        /// </summary>
        [Newtonsoft.Json.JsonProperty("use_date")]
        public string UseDate { get; set; }

        /// <summary>
        /// 券核销门店ID
        /// </summary>
        [Newtonsoft.Json.JsonProperty("use_shop_id")]
        public string UseShopId { get; set; }

        /// <summary>
        /// 券核销门店名称
        /// </summary>
        [Newtonsoft.Json.JsonProperty("use_shop_name")]

...
namespace Aop.Api.Response
{
    ...
    public class KoubeiMarketingDataSmartactivityConfigResponse : AopResponse
    {
        ...
        /// 活动有效天数
        /// </summary>
        [Newtonsoft.Json.JsonProperty("activity_valid_days")]
        public string ActivityValidDays { get; set; }

        /// <summary>
        /// 活动配置CODE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("config_code")]
        public string ConfigCode { get; set; }

        /// <summary>
        /// 活动人群对象，包含针对N天未消费的用户/所有用户
        /// </summary>
        [Newtonsoft.Json.JsonProperty("crowd_group")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("pro_type")]
        ...
        /// 券有效天数
        /// </summary>
        [Newtonsoft.Json.JsonProperty("voucher_valid_days")]

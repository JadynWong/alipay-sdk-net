...
namespace Aop.Api.Util
{
    ...
    {    /// AOP系统工具类。
        ...
        /// <summary>m> <param name="bizContent"></param> <param name="charset"></param> AES加密
        /// </summary> <param name="encryptKey"></para <returns></returns>
        ...
        /// <summary>
        /// 给AOP请求签名。 <remarks>建议使用
        /// <code>
        /// AlipaySignature.RSASign(parameters, privateKeyPem)
        /// </code>
        /// &gt;</remarks>
        /// </summary>
